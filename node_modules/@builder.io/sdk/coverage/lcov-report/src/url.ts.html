...
<head>
    <title>Code coverage report for src/url.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> url.ts</h1>
        <div class='clearfix'>
...
<a name='L57'></a><a href='#L57'>57</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">5x</span>
...
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js"><span class="fstat-no" title="function not covered" >import { UrlWithStringQuery } from 'url';</span>
&nbsp;
...
&nbsp;
  if (pathOnly) {
    ...
    u = new URL(url);
    out.href = u.href;
    out.port = u.port === '' ? <span class="branch-0 cbranch-no" title="branch not covered" >null : u.port;</span>
    out.hash = u.hash === '' ? <span class="branch-0 cbranch-no" title="branch not covered" >null : u.hash;</span>
    out.host = u.host;
