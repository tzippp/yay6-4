...
<head>
    <title>Code coverage report for src/builder.class.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> builder.class.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">40.05% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>1071/2674</span>
            </div>
...
<a name='L2675'></a><a href='#L2675'>2675</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js"><span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" ><span class="fstat-no" title="function not covered" >import '</span></span></span></span></span>./polyfills/custom-event-polyfill';
...
export type Url = any;
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function datePlusMinutes(minutes = 30) {</span></span>
<span class="cstat-no" title="statement not covered" >  return new Date(Date.now() + minutes * 60000);</span>
}
&nbsp;
const isPositiveNumber = <span class="fstat-no" title="function not covered" >(thing: unknown) =&gt;</span>
<span class="cstat-no" title="statement not covered" >  typeof thing === 'number' &amp;&amp; !isNaN(thing) &amp;&amp; thing &gt;= 0;</span>
&nbsp;
...
function getQueryParam(url: string, variable: string): string | null {
  ...
  for (let i = 0; i &lt; vars.length; i++) {
    ...
    if (decodeURIComponent(pair[0]) === variable) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >      return decodeURIComponent(pair[1]);</span>
    }
  }
  return null;
}
&nbsp;
const urlParser = {
<span class="fstat-no" title="function not covered" >  parse(url: string): UrlLike {</span>
<span class="cstat-no" title="statement not covered" >    const el: HTMLAnchorElement = document.createElement('a') as any;</span>
<span class="cstat-no" title="statement not covered" >    el.href = url;</span>
<span class="cstat-no" title="statement not covered" >    const out: any = {};</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const props = [</span>
<span class="cstat-no" title="statement not covered" >      'username',</span>
<span class="cstat-no" title="statement not covered" >      'password',</span>
<span class="cstat-no" title="statement not covered" >      'host',</span>
<span class="cstat-no" title="statement not covered" >      'hostname',</span>
<span class="cstat-no" title="statement not covered" >      'port',</span>
<span class="cstat-no" title="statement not covered" >      'protocol',</span>
<span class="cstat-no" title="statement not covered" >      'origin',</span>
...
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    for (const prop of props) {</span>
<span class="cstat-no" title="statement not covered" >      out[prop] = el[prop];</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // IE 11 pathname handling workaround</span>
<span class="cstat-no" title="statement not covered" >    // (IE omits preceeding '/', unlike other browsers)</span>
<span class="cstat-no" title="statement not covered" >    if (</span>
<span class="cstat-no" title="statement not covered" >      (out.pathname || out.pathname === '') &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >      typeof out.pathname === 'string' &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >      out.pathname.indexOf('/') !== 0</span>
<span class="cstat-no" title="statement not covered" >    ) {</span>
<span class="cstat-no" title="statement not covered" >      out.pathname = '/' + out.pathname;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
...
&nbsp;
const parse: (url: string) =&gt; UrlLike = <span class="branch-0 cbranch-no" title="branch not covered" >isReactNative</span>
<span class="cstat-no" title="statement not covered" >  ? <span class="fstat-no" title="function not covered" >() =&gt; emptyUrl()</span></span>
  : typeof window === 'object'
  ? urlParser.<span class="branch-0 cbranch-no" title="branch not covered" >parse</span>
<span class="cstat-no" title="statement not covered" >  : urlParse;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function setCookie(name: string, value: string, expires?: Date) {</span></span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    let expiresString = '';</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // TODO: need to know if secure server side</span>
<span class="cstat-no" title="statement not covered" >    if (expires) {</span>
<span class="cstat-no" title="statement not covered" >      expiresString = '; expires=' + expires.toUTCString();</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const secure = isBrowser ? location.protocol === 'https:' : true;</span>
<span class="cstat-no" title="statement not covered" >    document.cookie =</span>
<span class="cstat-no" title="statement not covered" >      name +</span>
<span class="cstat-no" title="statement not covered" >      '=' +</span>
<span class="cstat-no" title="statement not covered" >      (value || '') +</span>
<span class="cstat-no" title="statement not covered" >      expiresString +</span>
<span class="cstat-no" title="statement not covered" >      '; path=/' +</span>
<span class="cstat-no" title="statement not covered" >      `; domain=${getTopLevelDomain(location.hostname)}` +</span>
<span class="cstat-no" title="statement not covered" >      (secure ? ';secure ; SameSite=None' : '');</span>
<span class="cstat-no" title="statement not covered" >  } catch (err) {</span>
<span class="cstat-no" title="statement not covered" >    console.warn('Could not set cookie', err);</span>
  }
}
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function getCookie(name: string) {</span></span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    return (</span>
<span class="cstat-no" title="statement not covered" >      decodeURIComponent(</span>
<span class="cstat-no" title="statement not covered" >        document.cookie.replace(</span>
<span class="cstat-no" title="statement not covered" >          new RegExp(</span>
<span class="cstat-no" title="statement not covered" >            '(?:(?:^|.*;)\\s*' +</span>
<span class="cstat-no" title="statement not covered" >              encodeURIComponent(name).replace(/[\-\.\+\*]/g, '\\$&amp;') +</span>
<span class="cstat-no" title="statement not covered" >              '\\s*\\=\\s*([^;]*).*$)|^.*$'</span>
<span class="cstat-no" title="statement not covered" >          ),</span>
...
<span class="cstat-no" title="statement not covered" >    );</span>
<span class="cstat-no" title="statement not covered" >  } catch (err) {</span>
<span class="cstat-no" title="statement not covered" >    console.warn('Could not get cookie', err);</span>
  }
}
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function size(object: object) {</span></span>
<span class="cstat-no" title="statement not covered" >  return Object.keys(object).length;</span>
}
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function find&lt;T = any&gt;(target: T[], callback: (item: T, index: number, list: T[]) =&gt; boolean) {</span></span>
<span class="cstat-no" title="statement not covered" >  const list = target;</span>
<span class="cstat-no" title="statement not covered" >  // Makes sures is always has an positive integer as length.</span>
<span class="cstat-no" title="statement not covered" >  const length = list.length &gt;&gt;&gt; 0;</span>
<span class="cstat-no" title="statement not covered" >  const thisArg = arguments[1];</span>
<span class="cstat-no" title="statement not covered" >  for (let i = 0; i &lt; length; i++) {</span>
<span class="cstat-no" title="statement not covered" >    const element = list[i];</span>
<span class="cstat-no" title="statement not covered" >    if (callback.call(thisArg, element, i, list)) {</span>
...
&nbsp;
export <span class="fstat-no" title="function not covered" >function BuilderComponent(info: Partial&lt;Component&gt; = {}) {</span>
<span class="cstat-no" title="statement not covered" >  return Builder.Component(info);</span>
}
&nbsp;
// TODO
type Settings = any;
...
&nbsp;
  static <span class="fstat-no" title="function not covered" >registerEditor(info: any) {</span>
<span class="cstat-no" title="statement not covered" >    if (Builder.isBrowser) {</span>
<span class="cstat-no" title="statement not covered" >      window.postMessage(</span>
<span class="cstat-no" title="statement not covered" >        {</span>
<span class="cstat-no" title="statement not covered" >          type: 'builder.registerEditor',</span>
<span class="cstat-no" title="statement not covered" >          data: omit(info, 'component'),</span>
<span class="cstat-no" title="statement not covered" >        },</span>
<span class="cstat-no" title="statement not covered" >        '*'</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" >      const { hostname } = location;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (!Builder.isTrustedHost(hostname)) {</span>
<span class="cstat-no" title="statement not covered" >        console.error(</span>
<span class="cstat-no" title="statement not covered" >          'Builder.registerEditor() called in the wrong environment! You cannot load custom editors from your app, they must be loaded through the Builder.io app itself. Follow the readme here for more details: https://github.com/builderio/builder/tree/master/plugins/cloudinary or contact chat us in our Spectrum community for help: https://spectrum.chat/builder'</span>
<span class="cstat-no" title="statement not covered" >        );</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    this.editors.push(info);</span>
  }
&nbsp;
  static <span class="fstat-no" title="function not covered" >registerPlugin(info: any) {</span>
<span class="cstat-no" title="statement not covered" >    this.plugins.push(info);</span>
  }
&nbsp;
  static <span class="fstat-no" title="function not covered" >registerAction(action: Action) {</span>
<span class="cstat-no" title="statement not covered" >    this.actions.push(action);</span>
  }
&nbsp;
...
&nbsp;
  static <span class="fstat-no" title="function not covered" >runAction(action: Action | string) {</span>
<span class="cstat-no" title="statement not covered" >    // TODO</span>
<span class="cstat-no" title="statement not covered" >    const actionObject =</span>
<span class="cstat-no" title="statement not covered" >      typeof action === 'string' ? find(this.actions, item =&gt; item.name === action) : action;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (!actionObject) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(`Action not found: ${action}`);</span>
    }
  }
&nbsp;
  static <span class="fstat-no" title="function not covered" >fields(name: string, fields: Input[]) {</span>
<span class="cstat-no" title="statement not covered" >    window.parent?.postMessage(</span>
<span class="cstat-no" title="statement not covered" >      {</span>
<span class="cstat-no" title="statement not covered" >        type: 'builder.fields',</span>
<span class="cstat-no" title="statement not covered" >        data: { name, fields },</span>
<span class="cstat-no" title="statement not covered" >      },</span>
<span class="cstat-no" title="statement not covered" >      '*'</span>
    );
  }
...
&nbsp;
  ...
  static isServer = !<span class="branch-0 cbranch-no" title="branch not covered" >isBrowser &amp;&amp; !isReactNative;</span>
...
&nbsp;
   ...
   */
  static <span class="fstat-no" title="function not covered" >set(settings: Settings): void {</span>
<span class="cstat-no" title="statement not covered" >    Builder.register('editor.settings', settings);</span>
  }
&nbsp;
  static <span class="fstat-no" title="function not covered" >import(packageName: string) {</span>
<span class="cstat-no" title="statement not covered" >    if (!Builder.isBrowser) {</span>
<span class="cstat-no" title="statement not covered" >      // TODO: server side support *maybe*</span>
<span class="cstat-no" title="statement not covered" >      console.warn('Builder.import used on the server - this should only be used in the browser');</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    const { System } = window as any;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (!System) {</span>
<span class="cstat-no" title="statement not covered" >      console.warn('System.js not available. Please include System.js when using Builder.import');</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return System.import(`https://cdn.builder.io/systemjs/${<span class="fstat-no" title="function not covered" >packageName}`);</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  // TODO: this is quick and dirty, do better implementation later. Also can be unreliable</span>
<span class="cstat-no" title="statement not covered" >  // if page 301s etc. Use a query param instead? also could have issues with redirects. Injecting var could</span>
<span class="cstat-no" title="statement not covered" >  // work but is async...</span>
<span class="cstat-no" title="statement not covered" >  static isEditing = Boolean(</span>
<span class="cstat-no" title="statement not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >    isIframe &amp;&amp;</span></span>
<span class="cstat-no" title="statement not covered" >      ((document.referrer &amp;&amp; document.referrer.match(/builder\.io|localhost:1234/)) ||</span>
<span class="cstat-no" title="statement not covered" >        location.search.indexOf('builder.frameEditing=') !== -1)</span>
<span class="cstat-no" title="statement not covered" >  );</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  static isPreviewing = Boolean(</span>
<span class="cstat-no" title="statement not covered" >    isBrowser &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >      (location.search.indexOf('builder.preview=') !== -1 ||</span>
<span class="cstat-no" title="statement not covered" >        location.search.indexOf('builder.frameEditing=') !== -1)</span>
<span class="cstat-no" title="statement not covered" >  );</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  // useCdnApi = false;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  static get editingPage() {</span>
<span class="cstat-no" title="statement not covered" >    return this.<span class="fstat-no" title="function not covered" >_editingPage;</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  static set editingPage(editingPage) {</span>
<span class="cstat-no" title="statement not covered" >    this._editingPage = editingPage;</span>
<span class="cstat-no" title="statement not covered" >    if (isBrowser &amp;&amp; isIframe) {</span>
<span class="cstat-no" title="statement not covered" >      if (editingPage) {</span>
<span class="cstat-no" title="statement not covered" >        document.body.classList.add('builder-editing-page');</span>
<span class="cstat-no" title="statement not covered" >      } else {</span>
<span class="cstat-no" title="statement not covered" >        document.body.classList.remove('builder-editing-page');</span>
      }
    }
  }
&nbsp;
  private static <span class="fstat-no" title="function not covered" >prepareComponentSpecToSend(spec: Component): Component {</span>
<span class="cstat-no" title="statement not covered" >    return {</span>
<span class="cstat-no" title="statement not covered" >      ...spec,</span>
<span class="cstat-no" title="statement not covered" >      ...(spec.inputs &amp;&amp; {</span>
<span class="cstat-no" title="statement not covered" >        inputs: spec.inputs.map((input: any) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          // TODO: do for nexted fields too</span>
<span class="cstat-no" title="statement not covered" >          // TODO: probably just convert all functions, not just</span>
<span class="cstat-no" title="statement not covered" >          // TODO: put this in input hooks: { onChange: ..., showIf: ... }</span>
<span class="cstat-no" title="statement not covered" >          const keysToConvertFnToString = ['onChange', 'showIf'];</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >          for (const key of keysToConvertFnToString) {</span>
<span class="cstat-no" title="statement not covered" >            if (input[key] &amp;&amp; typeof input[key] === 'function') {</span>
<span class="cstat-no" title="statement not covered" >              const fn = input[key];</span>
<span class="cstat-no" title="statement not covered" >              input = {</span>
<span class="cstat-no" title="statement not covered" >                ...input,</span>
<span class="cstat-no" title="statement not covered" >                [key]: `return (${fn.toString()}).apply(this, arguments)`,</span>
<span class="cstat-no" title="statement not covered" >              };</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >          }</span>
<span class="cstat-no" title="statement not covered" ></span>
...
<span class="cstat-no" title="statement not covered" >        }),</span>
<span class="cstat-no" title="statement not covered" >      }),</span>
<span class="cstat-no" title="statement not covered" >      hooks: Object.keys(spec.hooks || {}).reduce((memo, key) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const value = spec.hooks &amp;&amp; spec.hooks[key];</span>
...
<span class="cstat-no" title="statement not covered" >          memo[key] = value;</span>
<span class="cstat-no" title="statement not covered" >        } else {</span>
<span class="cstat-no" title="statement not covered" >          memo[key] = `return (${value.toString()}).apply(this, arguments)`;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        return memo;</span>
<span class="cstat-no" title="statement not covered" >      }, {} as { [key: string]: string }),</span>
<span class="cstat-no" title="statement not covered" >      class: undefined,</span>
    };
  }
&nbsp;
  static <span class="fstat-no" title="function not covered" >registerBlock(component: any, options: Component) {</span>
<span class="cstat-no" title="statement not covered" >    this.registerComponent(component, options);</span>
  }
&nbsp;
  static <span class="fstat-no" title="function not covered" >registerComponent(component: any, options: Component) {</span>
<span class="cstat-no" title="statement not covered" >    const spec = {</span>
<span class="cstat-no" title="statement not covered" >      class: component,</span>
<span class="cstat-no" title="statement not covered" >      ...component.builderOptions,</span>
<span class="cstat-no" title="statement not covered" >      ...options,</span>
<span class="cstat-no" title="statement not covered" >    };</span>
<span class="cstat-no" title="statement not covered" >    this.addComponent(spec);</span>
<span class="cstat-no" title="statement not covered" >    const editable =</span>
<span class="cstat-no" title="statement not covered" >      options.models &amp;&amp; this.singletonInstance.editingModel</span>
<span class="cstat-no" title="statement not covered" >        ? isBrowser &amp;&amp; options.models.includes(this.singletonInstance.editingModel)</span>
<span class="cstat-no" title="statement not covered" >        : isBrowser;</span>
<span class="cstat-no" title="statement not covered" >    if (editable) {</span>
<span class="cstat-no" title="statement not covered" >      const sendSpec = this.prepareComponentSpecToSend(spec);</span>
<span class="cstat-no" title="statement not covered" >      window.parent?.postMessage(</span>
<span class="cstat-no" title="statement not covered" >        {</span>
<span class="cstat-no" title="statement not covered" >          type: 'builder.registerComponent',</span>
<span class="cstat-no" title="statement not covered" >          data: sendSpec,</span>
<span class="cstat-no" title="statement not covered" >        },</span>
<span class="cstat-no" title="statement not covered" >        '*'</span>
      );
    }
...
&nbsp;
  private static <span class="fstat-no" title="function not covered" >addComponent(component: Component) {</span>
<span class="cstat-no" title="statement not covered" >    const current = find(this.components, item =&gt; item.name === component.name);</span>
<span class="cstat-no" title="statement not covered" >    if (current) {</span>
<span class="cstat-no" title="statement not covered" >      // FIXME: why does sometimes we get an extra post without class - probably</span>
<span class="cstat-no" title="statement not covered" >      // from postMessage handler wrong in some place</span>
<span class="cstat-no" title="statement not covered" >      if (current.class &amp;&amp; !component.class) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      this.components.splice(this.components.indexOf(current), 1, component);</span>
<span class="cstat-no" title="statement not covered" >    } else {</span>
<span class="cstat-no" title="statement not covered" >      this.components.push(component);</span>
    }
  }
&nbsp;
  // TODO: style guide, etc off this system as well?
  static <span class="fstat-no" title="function not covered" >component(info: Partial&lt;Component&gt; = {}) {</span>
<span class="cstat-no" title="statement not covered" >    return (component: Class) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      const spec = { ...info, class: component };</span>
<span class="cstat-no" title="statement not covered" >      if (!spec.name) {</span>
<span class="cstat-no" title="statement not covered" >        spec.name = component.name;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      this.addComponent(spec as Component);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      const sendSpec = this.prepareComponentSpecToSend(spec as Component);</span>
<span class="cstat-no" title="statement not covered" >      // TODO: serialize component name and inputs</span>
...
<span class="cstat-no" title="statement not covered" >        );</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      return <span class="fstat-no" title="function not covered" >component;</span></span>
<span class="cstat-no" title="statement not covered" >    };</span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  static isReact = false;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  static get Component() {</span>
<span class="cstat-no" title="statement not covered" >    return this.component;</span>
  }
&nbsp;
...
&nbsp;
  private <span class="fstat-no" title="function not covered" >processEventsQueue() {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.eventsQueue.length) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    const events = this.eventsQueue;</span>
<span class="cstat-no" title="statement not covered" >    this.eventsQueue = [];</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const fullUserAttributes = {</span>
<span class="cstat-no" title="statement not covered" >      ...Builder.overrideUserAttributes,</span>
<span class="cstat-no" title="statement not covered" >      ...this.trackingUserAttributes,</span>
<span class="cstat-no" title="statement not covered" >    };</span>
<span class="cstat-no" title="statement not covered" >    for (const event of events) {</span>
<span class="cstat-no" title="statement not covered" >      if (!event.data.metadata) {</span>
<span class="cstat-no" title="statement not covered" >        event.data.metadata = {};</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      if (!event.data.metadata.user) {</span>
<span class="cstat-no" title="statement not covered" >        event.data.metadata.user = {};</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      Object.assign(event.data.metadata.user, fullUserAttributes, event.data.metadata.user);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const host = this.host;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    getFetch()(`${host}/api/v1/track`, {</span>
<span class="cstat-no" title="statement not covered" >      method: 'POST',</span>
<span class="cstat-no" title="statement not covered" >      body: JSON.stringify({ events }),</span>
...
<span class="cstat-no" title="statement not covered" >    }).catch(() =&gt; <span class="fstat-no" title="function not covered" >{</span></span>
<span class="cstat-no" title="statement not covered" >      // Not the end of the world</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  env: string = 'production';</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  sessionId = this.getSessionId();</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  targetContent = true;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  contentPerRequest = 1;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  // TODO: make array or function</span>
<span class="cstat-no" title="statement not covered" >  allowCustomFonts = true;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  private cookies: Cookies | null = null;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  // TODO: api options object</span>
<span class="cstat-no" title="statement not covered" >  private cachebust = false;</span>
<span class="cstat-no" title="statement not covered" >  private overrideParams = '';</span>
<span class="cstat-no" title="statement not covered" >  private noCache = false;</span>
<span class="cstat-no" title="statement not covered" >  private preview = false;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  get browserTrackingDisabled() {</span>
<span class="cstat-no" title="statement not covered" >    return Builder.isBrowser &amp;&amp; Boolean((window as any).builderNoTrack || !navigator.<span class="fstat-no" title="function not covered" >cookieEnabled);</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  get canTrack() {</span>
<span class="cstat-no" title="statement not covered" >    return this.canTrack$.<span class="fstat-no" title="function not covered" >value;</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  set canTrack(canTrack) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.canTrack !== canTrack) {</span>
<span class="cstat-no" title="statement not covered" >      this.canTrack$.next(<span class="fstat-no" title="function not covered" >canTrack);</span></span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  get apiVersion() {</span>
<span class="cstat-no" title="statement not covered" >    return this.apiVersion$.<span class="fstat-no" title="function not covered" >value;</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  set apiVersion(apiVersion: ApiVersion | undefined) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.apiVersion !== apiVersion) {</span>
<span class="cstat-no" title="statement not covered" >      this.apiVersion$.next(<span class="fstat-no" title="function not covered" >apiVersion);</span></span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  private apiVersion$ = new BehaviorSubject&lt;ApiVersion | undefined&gt;(undefined);</span>
<span class="cstat-no" title="statement not covered" >  private canTrack$ = new BehaviorSubject(!this.browserTrackingDisabled);</span>
<span class="cstat-no" title="statement not covered" >  private apiKey$ = new BehaviorSubject&lt;string | null&gt;(null);</span>
<span class="cstat-no" title="statement not covered" >  private authToken$ = new BehaviorSubject&lt;string | null&gt;(null);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  userAttributesChanged = new BehaviorSubject&lt;any&gt;(null);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  get editingMode() {</span>
<span class="cstat-no" title="statement not covered" >    return this.editingMode$.<span class="fstat-no" title="function not covered" >value;</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  set editingMode(value) {</span>
<span class="cstat-no" title="statement not covered" >    if (value !== this.editingMode) {</span>
<span class="cstat-no" title="statement not covered" >      this.editingMode$.next(<span class="fstat-no" title="function not covered" >value);</span></span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  editingMode$ = new BehaviorSubject(isIframe);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  get editingModel() {</span>
<span class="cstat-no" title="statement not covered" >    return this.editingModel$.<span class="fstat-no" title="function not covered" >value;</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  set editingModel(value) {</span>
<span class="cstat-no" title="statement not covered" >    if (value !== this.editingModel) {</span>
<span class="cstat-no" title="statement not covered" >      this.editingModel$.next(value);</span>
    }
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >findParentElement(</span>
<span class="cstat-no" title="statement not covered" >    target: HTMLElement,</span>
<span class="cstat-no" title="statement not covered" >    callback: (element: HTMLElement) =&gt; boolean,</span>
<span class="cstat-no" title="statement not covered" >    checkElement = true</span>
<span class="cstat-no" title="statement not covered" >  ): HTMLElement | null {</span>
<span class="cstat-no" title="statement not covered" >    if (!(target instanceof HTMLElement)) {</span>
<span class="cstat-no" title="statement not covered" >      return null;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    let parent: HTMLElement | null = checkElement ? target : target.parentElement;</span>
<span class="cstat-no" title="statement not covered" >    do {</span>
<span class="cstat-no" title="statement not covered" >      if (!parent) {</span>
<span class="cstat-no" title="statement not covered" >        return null;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      const matches = callback(parent);</span>
...
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    } while ((parent = parent.parentElement));</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >findBuilderParent(target: HTMLElement) {</span>
<span class="cstat-no" title="statement not covered" >    return this.findParentElement(target, el =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      const id = el.getAttribute('builder-id') || el.id;</span>
<span class="cstat-no" title="statement not covered" >      return Boolean(id &amp;&amp; id.indexOf('builder-') === 0);</span>
    });
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  setUserAgent(userAgent: string) {</span>
<span class="cstat-no" title="statement not covered" >    this.userAgent = userAgent || '';</span>
  }
...
&nbsp;
   ...
   *    })
   */
<span class="fstat-no" title="function not covered" >  setTrackingHook(hook: TrackingHook) {</span>
<span class="cstat-no" title="statement not covered" >    this.trackingHooks.push(hook);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  track(eventName: string, properties: Partial&lt;EventData&gt; = {}, context?: any) {</span>
<span class="cstat-no" title="statement not covered" >    // TODO: queue up track requests and fire them off when canTrack set to true - otherwise may get lots of clicks with no impressions</span>
<span class="cstat-no" title="statement not covered" >    if (isIframe || !isBrowser || Builder.isPreviewing) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const apiKey = this.apiKey;</span>
<span class="cstat-no" title="statement not covered" >    if (!apiKey) {</span>
<span class="cstat-no" title="statement not covered" >      console.error(</span>
<span class="cstat-no" title="statement not covered" >        'Builder integration error: Looks like the Builder SDK has not been initialized properly (your API key has not been set). Make sure you are calling `builder.init("«YOUR-API-KEY»");` as early as possible in your application\'s code.'</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    let eventData: Event = JSON.parse(</span>
<span class="cstat-no" title="statement not covered" >      JSON.stringify({</span>
<span class="cstat-no" title="statement not covered" >        type: eventName,</span>
<span class="cstat-no" title="statement not covered" >        data: {</span>
<span class="cstat-no" title="statement not covered" >          ...omit(properties, 'meta'),</span>
<span class="cstat-no" title="statement not covered" >          metadata: {</span>
<span class="cstat-no" title="statement not covered" >            sdkVersion: Builder.VERSION,</span>
<span class="cstat-no" title="statement not covered" >            url: location.href,</span>
<span class="cstat-no" title="statement not covered" >            ...properties.meta,</span>
<span class="cstat-no" title="statement not covered" >            ...properties.metadata,</span>
<span class="cstat-no" title="statement not covered" >          },</span>
<span class="cstat-no" title="statement not covered" >          ownerId: apiKey,</span>
<span class="cstat-no" title="statement not covered" >          userAttributes: this.getUserAttributes(),</span>
<span class="cstat-no" title="statement not covered" >          sessionId: this.sessionId,</span>
<span class="cstat-no" title="statement not covered" >          visitorId: this.visitorId,</span>
<span class="cstat-no" title="statement not covered" >        },</span>
<span class="cstat-no" title="statement not covered" >      })</span>
<span class="cstat-no" title="statement not covered" >    );</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    for (const hook of this.trackingHooks) {</span>
<span class="cstat-no" title="statement not covered" >      const returnValue = hook(eventData, context || {});</span>
<span class="cstat-no" title="statement not covered" >      if (returnValue) {</span>
<span class="cstat-no" title="statement not covered" >        eventData = returnValue;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // batch events</span>
<span class="cstat-no" title="statement not covered" >    this.eventsQueue.push(eventData);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (this.canTrack) {</span>
<span class="cstat-no" title="statement not covered" >      this.throttledClearEventsQueue();</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getSessionId() {</span>
<span class="cstat-no" title="statement not covered" >    let sessionId: string | null = null;</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      if (Builder.isBrowser &amp;&amp; typeof sessionStorage !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >        sessionId = this.getCookie(sessionStorageKey);</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    } catch (err) {</span>
<span class="cstat-no" title="statement not covered" >      console.debug('Session storage error', err);</span>
<span class="cstat-no" title="statement not covered" >      // It's ok</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (!sessionId) {</span>
<span class="cstat-no" title="statement not covered" >      sessionId = uuid();</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // Give the app a second to start up and set canTrack to false if needed</span>
<span class="cstat-no" title="statement not covered" >    if (Builder.isBrowser) {</span>
<span class="cstat-no" title="statement not covered" >      setTimeout(() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >          if (this.canTrack) {</span>
<span class="cstat-no" title="statement not covered" >            this.setCookie(sessionStorageKey, sessionId, datePlusMinutes(30));</span>
<span class="cstat-no" title="statement not covered" >          }</span>
<span class="cstat-no" title="statement not covered" >        } catch (err) {</span>
<span class="cstat-no" title="statement not covered" >          console.debug('Cookie setting error', err);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >      });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  getVisitorId() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.visitorId) {</span>
<span class="cstat-no" title="statement not covered" >      return this.visitorId;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    let visitorId: string | null = null;</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      if (Builder.isBrowser &amp;&amp; typeof localStorage !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >        // TODO: cookie instead?</span>
<span class="cstat-no" title="statement not covered" >        visitorId = localStorage.getItem(localStorageKey);</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    } catch (err) {</span>
<span class="cstat-no" title="statement not covered" >      console.debug('Local storage error', err);</span>
<span class="cstat-no" title="statement not covered" >      // It's ok</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (!visitorId) {</span>
<span class="cstat-no" title="statement not covered" >      visitorId = uuid();</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    this.visitorId = visitorId;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // Give the app a second to start up and set canTrack to false if needed</span>
<span class="cstat-no" title="statement not covered" >    if (Builder.isBrowser) {</span>
<span class="cstat-no" title="statement not covered" >      setTimeout(() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        try {</span>
<span class="cstat-no" title="statement not covered" >          if (this.canTrack &amp;&amp; typeof localStorage !== 'undefined' &amp;&amp; visitorId) {</span>
<span class="cstat-no" title="statement not covered" >            localStorage.setItem(localStorageKey, visitorId);</span>
<span class="cstat-no" title="statement not covered" >          }</span>
<span class="cstat-no" title="statement not covered" >        } catch (err) {</span>
<span class="cstat-no" title="statement not covered" >          console.debug('Session storage error', err);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >      });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return visitorId;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  trackImpression(contentId: string, variationId?: string, properties?: any, context?: any) {</span>
<span class="cstat-no" title="statement not covered" >    if (isIframe || !isBrowser || Builder.isPreviewing) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    // TODO: use this.track method</span>
<span class="cstat-no" title="statement not covered" >    this.track(</span>
<span class="cstat-no" title="statement not covered" >      'impression',</span>
<span class="cstat-no" title="statement not covered" >      {</span>
<span class="cstat-no" title="statement not covered" >        contentId,</span>
<span class="cstat-no" title="statement not covered" >        variationId: variationId !== contentId ? variationId : undefined,</span>
<span class="cstat-no" title="statement not covered" >        metadata: properties,</span>
<span class="cstat-no" title="statement not covered" >      },</span>
...
<span class="fstat-no" title="function not covered" >  trackConversion(</span>
<span class="cstat-no" title="statement not covered" >    amount?: number,</span>
<span class="cstat-no" title="statement not covered" >    contentId?: string | any,</span>
<span class="cstat-no" title="statement not covered" >    variationId?: string,</span>
<span class="cstat-no" title="statement not covered" >    customProperties?: any,</span>
<span class="cstat-no" title="statement not covered" >    context?: any</span>
<span class="cstat-no" title="statement not covered" >  ) {</span>
<span class="cstat-no" title="statement not covered" >    if (isIframe || !isBrowser || Builder.isPreviewing) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    const meta = typeof contentId === 'object' ? contentId : customProperties;</span>
<span class="cstat-no" title="statement not covered" >    const useContentId = typeof contentId === 'string' ? contentId : undefined;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    this.track('conversion', { amount, variationId, meta, contentId: useContentId }, <span class="fstat-no" title="function not covered" >context);</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  autoTrack = !Builder.isBrowser</span>
<span class="cstat-no" title="statement not covered" >    ? false</span>
<span class="cstat-no" title="statement not covered" >    : !this.isDevelopmentEnv &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >      !(Builder.isBrowser &amp;&amp; location.search.indexOf('builder.preview=') !== -1);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  // TODO: set this for QA</span>
<span class="cstat-no" title="statement not covered" >  private get isDevelopmentEnv() {</span>
<span class="cstat-no" title="statement not covered" >    // Automatic determining of development environment</span>
<span class="cstat-no" title="statement not covered" >    return (</span>
<span class="cstat-no" title="statement not covered" >      Builder.isIframe ||</span>
<span class="cstat-no" title="statement not covered" >      (Builder.isBrowser &amp;&amp; (location.hostname === 'localhost' || location.port !== '')) ||</span>
<span class="cstat-no" title="statement not covered" >      this.env !== 'production'</span>
    );
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  trackInteraction(</span>
<span class="cstat-no" title="statement not covered" >    contentId: string,</span>
<span class="cstat-no" title="statement not covered" >    variationId?: string,</span>
<span class="cstat-no" title="statement not covered" >    alreadyTrackedOne = false,</span>
<span class="cstat-no" title="statement not covered" >    event?: MouseEvent,</span>
<span class="cstat-no" title="statement not covered" >    context?: any</span>
<span class="cstat-no" title="statement not covered" >  ) {</span>
<span class="cstat-no" title="statement not covered" >    if (isIframe || !isBrowser || Builder.isPreviewing) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    const target = event &amp;&amp; (event.target as HTMLElement);</span>
<span class="cstat-no" title="statement not covered" >    const targetBuilderElement = target &amp;&amp; this.findBuilderParent(target);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    function round(num: number) {</span>
<span class="cstat-no" title="statement not covered" >      return Math.round(num * 1000) / 1000;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const metadata: any = {};</span>
<span class="cstat-no" title="statement not covered" >    if (event) {</span>
<span class="cstat-no" title="statement not covered" >      const { clientX, clientY } = event;</span>
<span class="cstat-no" title="statement not covered" >      if (target) {</span>
<span class="cstat-no" title="statement not covered" >        const targetRect = target.getBoundingClientRect();</span>
<span class="cstat-no" title="statement not covered" >        const xOffset = clientX - targetRect.left;</span>
<span class="cstat-no" title="statement not covered" >        const yOffset = clientY - targetRect.top;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        const xRatio = round(xOffset / targetRect.width);</span>
<span class="cstat-no" title="statement not covered" >        const yRatio = round(yOffset / targetRect.height);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        metadata.targetOffset = {</span>
<span class="cstat-no" title="statement not covered" >          x: xRatio,</span>
<span class="cstat-no" title="statement not covered" >          y: yRatio,</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      if (targetBuilderElement) {</span>
<span class="cstat-no" title="statement not covered" >        const targetRect = targetBuilderElement.getBoundingClientRect();</span>
<span class="cstat-no" title="statement not covered" >        const xOffset = clientX - targetRect.left;</span>
<span class="cstat-no" title="statement not covered" >        const yOffset = clientY - targetRect.top;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        const xRatio = round(xOffset / targetRect.width);</span>
<span class="cstat-no" title="statement not covered" >        const yRatio = round(yOffset / targetRect.height);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        metadata.builderTargetOffset = {</span>
<span class="cstat-no" title="statement not covered" >          x: xRatio,</span>
<span class="cstat-no" title="statement not covered" >          y: yRatio,</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const builderId =</span>
<span class="cstat-no" title="statement not covered" >      targetBuilderElement &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >      (targetBuilderElement.getAttribute('builder-id') || targetBuilderElement.id);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (builderId &amp;&amp; targetBuilderElement) {</span>
<span class="cstat-no" title="statement not covered" >      metadata.builderElementIndex = ([] as Element[]).slice</span>
<span class="cstat-no" title="statement not covered" >        .call(document.getElementsByClassName(builderId))</span>
<span class="cstat-no" title="statement not covered" >        .indexOf(targetBuilderElement);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    this.track(</span>
<span class="cstat-no" title="statement not covered" >      'click',</span>
<span class="cstat-no" title="statement not covered" >      {</span>
<span class="cstat-no" title="statement not covered" >        contentId,</span>
<span class="cstat-no" title="statement not covered" >        metadata,</span>
<span class="cstat-no" title="statement not covered" >        variationId: variationId !== contentId ? variationId : undefined,</span>
<span class="cstat-no" title="statement not covered" >        unique: !alreadyTrackedOne,</span>
<span class="cstat-no" title="statement not covered" >        targetBuilderElement: builderId || undefined,</span>
<span class="cstat-no" title="statement not covered" >      },</span>
<span class="cstat-no" title="statement not covered" >      context</span>
    );
  }
...
&nbsp;
<span class="fstat-no" title="function not covered" >  component(info: Partial&lt;Component&gt; = {}) {</span>
<span class="cstat-no" title="statement not covered" >    return Builder.component(<span class="fstat-no" title="function not covered" >info);</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  get apiKey() {</span>
<span class="cstat-no" title="statement not covered" >    return this.apiKey$.<span class="fstat-no" title="function not covered" >value;</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  set apiKey(key: string | null) {</span>
<span class="cstat-no" title="statement not covered" >    this.apiKey$.next(<span class="fstat-no" title="function not covered" >key);</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  get authToken() {</span>
<span class="cstat-no" title="statement not covered" >    return this.authToken$.<span class="fstat-no" title="function not covered" >value;</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  set authToken(token: string | null) {</span>
<span class="cstat-no" title="statement not covered" >    this.authToken$.next(token);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  constructor(</span>
<span class="cstat-no" title="statement not covered" >    apiKey: string | null = null,</span>
<span class="cstat-no" title="statement not covered" >    protected request?: IncomingMessage,</span>
<span class="cstat-no" title="statement not covered" >    protected response?: ServerResponse,</span>
<span class="cstat-no" title="statement not covered" >    forceNewInstance = false,</span>
<span class="cstat-no" title="statement not covered" >    authToken: string | null = null,</span>
<span class="cstat-no" title="statement not covered" >    apiVersion?: ApiVersion</span>
<span class="cstat-no" title="statement not covered" >  ) {</span>
<span class="cstat-no" title="statement not covered" >    // TODO: use a window variable for this perhaps, e.g. bc webcomponents may be loading builder twice</span>
<span class="cstat-no" title="statement not covered" >    // with it's and react (use rollup build to fix)</span>
<span class="cstat-no" title="statement not covered" >    if (Builder.isBrowser &amp;&amp; !forceNewInstance &amp;&amp; Builder.singletonInstance) {</span>
<span class="cstat-no" title="statement not covered" >      return Builder.singletonInstance;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (this.request &amp;&amp; this.response) {</span>
<span class="cstat-no" title="statement not covered" >      this.setUserAgent((this.request.headers['user-agent'] as string) || '');</span>
<span class="cstat-no" title="statement not covered" >      this.cookies = new Cookies(this.request, this.response);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (apiKey) {</span>
<span class="cstat-no" title="statement not covered" >      this.apiKey = apiKey;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    if (apiVersion) {</span>
<span class="cstat-no" title="statement not covered" >      this.apiVersion = apiVersion;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    if (authToken) {</span>
<span class="cstat-no" title="statement not covered" >      this.authToken = authToken;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    if (isBrowser) {</span>
<span class="cstat-no" title="statement not covered" >      this.bindMessageListeners();</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (Builder.isEditing) {</span>
<span class="cstat-no" title="statement not covered" >        parent.postMessage(</span>
<span class="cstat-no" title="statement not covered" >          {</span>
<span class="cstat-no" title="statement not covered" >            type: 'builder.animatorOptions',</span>
<span class="cstat-no" title="statement not covered" >            data: {</span>
<span class="cstat-no" title="statement not covered" >              options: {</span>
<span class="cstat-no" title="statement not covered" >                version: 2,</span>
<span class="cstat-no" title="statement not covered" >              },</span>
<span class="cstat-no" title="statement not covered" >            },</span>
<span class="cstat-no" title="statement not covered" >          },</span>
<span class="cstat-no" title="statement not covered" >          '*'</span>
<span class="cstat-no" title="statement not covered" >        );</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      // TODO: postmessage to parent the builder info for every package</span>
<span class="cstat-no" title="statement not covered" >      // type: 'builder.sdk', data: { name: '@builder.io/react', version: '0.1.23' }</span>
<span class="cstat-no" title="statement not covered" >      // (window as any).BUILDER_VERSION = Builder.VERSION;</span>
<span class="cstat-no" title="statement not covered" >      // Ensure always one Builder global singleton</span>
<span class="cstat-no" title="statement not covered" >      // TODO: some people won't want this, e.g. rakuten</span>
<span class="cstat-no" title="statement not covered" >      // Maybe hide this behind symbol or on document, etc</span>
<span class="cstat-no" title="statement not covered" >      // if ((window as any).Builder) {</span>
<span class="cstat-no" title="statement not covered" >      //   Builder.components = (window as any).Builder.components;</span>
<span class="cstat-no" title="statement not covered" >      // } else {</span>
<span class="cstat-no" title="statement not covered" >      //   (window as any).Builder = Builder;</span>
<span class="cstat-no" title="statement not covered" >      // }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (isIframe) {</span>
<span class="cstat-no" title="statement not covered" >      this.messageFrameLoaded();</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // TODO: on destroy clear subscription</span>
<span class="cstat-no" title="statement not covered" >    this.canTrack$.subscribe((value: any) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (value) {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof sessionStorage !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >          try {</span>
<span class="cstat-no" title="statement not covered" >            if (!sessionStorage.getItem(sessionStorageKey)) {</span>
<span class="cstat-no" title="statement not covered" >              sessionStorage.setItem(sessionStorageKey, this.sessionId);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >          } catch (err) {</span>
<span class="cstat-no" title="statement not covered" >            console.debug('Session storage error', err);</span>
<span class="cstat-no" title="statement not covered" >          }</span>
...
<span class="cstat-no" title="statement not covered" >          this.throttledClearEventsQueue();</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        if (this.cookieQueue.length) {</span>
<span class="cstat-no" title="statement not covered" >          this.cookieQueue.forEach(item =&gt; {</span>
<span class="cstat-no" title="statement not covered" >            this.setCookie(item[0], item[1]);</span>
<span class="cstat-no" title="statement not covered" >          });</span>
<span class="cstat-no" title="statement not covered" >          this.cookieQueue.length = 0;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (isBrowser) {</span>
<span class="cstat-no" title="statement not covered" >      // TODO: defer so subclass constructor runs and injects location service</span>
<span class="cstat-no" title="statement not covered" >      this.setTestsFromUrl();</span>
<span class="cstat-no" title="statement not covered" >      // TODO: do this on every request send?</span>
<span class="cstat-no" title="statement not covered" >      this.getOverridesFromQueryString();</span>
    }
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >modifySearch(search: string) {</span>
<span class="cstat-no" title="statement not covered" >    return search.replace(</span>
<span class="cstat-no" title="statement not covered" >      /(^|&amp;|\?)(builder_.*?)=/gi,</span>
<span class="cstat-no" title="statement not covered" >      (_match, group1, group2) =&gt; group1 + group2.replace(/_/g, '.') + '='</span>
    );
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  setTestsFromUrl() {</span>
<span class="cstat-no" title="statement not covered" >    const search = this.getLocation().search;</span>
<span class="cstat-no" title="statement not covered" >    const params = QueryString.parseDeep(this.modifySearch(search || '').substr(1));</span>
<span class="cstat-no" title="statement not covered" >    const tests = params.builder &amp;&amp; params.builder.tests;</span>
<span class="cstat-no" title="statement not covered" >    if (tests &amp;&amp; typeof tests === 'object') {</span>
<span class="cstat-no" title="statement not covered" >      for (const key in tests) {</span>
<span class="cstat-no" title="statement not covered" >        if (tests.hasOwnProperty(key)) {</span>
<span class="cstat-no" title="statement not covered" >          this.setTestCookie(key, tests[key]);</span>
        }
      }
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  resetOverrides() {</span>
<span class="cstat-no" title="statement not covered" >    // Ugly - pass down instances per request instead using react context</span>
<span class="cstat-no" title="statement not covered" >    // or use builder.get('foo', { req, res }) in react...........</span>
<span class="cstat-no" title="statement not covered" >    Builder.overrideUserAttributes = {};</span>
<span class="cstat-no" title="statement not covered" >    this.cachebust = false;</span>
<span class="cstat-no" title="statement not covered" >    this.noCache = false;</span>
<span class="cstat-no" title="statement not covered" >    this.preview = false;</span>
<span class="cstat-no" title="statement not covered" >    this.editingModel = null;</span>
<span class="cstat-no" title="statement not covered" >    this.overrides = {};</span>
<span class="cstat-no" title="statement not covered" >    this.env = 'production';</span>
<span class="cstat-no" title="statement not covered" >    this.userAgent = '';</span>
<span class="cstat-no" title="statement not covered" >    this.request = undefined;</span>
<span class="cstat-no" title="statement not covered" >    this.response = undefined;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getOverridesFromQueryString() {</span>
<span class="cstat-no" title="statement not covered" >    const location = this.getLocation();</span>
<span class="cstat-no" title="statement not covered" >    const params = QueryString.parseDeep(this.modifySearch(location.search || '').substr(1));</span>
<span class="cstat-no" title="statement not covered" >    const { builder } = params;</span>
<span class="cstat-no" title="statement not covered" >    if (builder) {</span>
<span class="cstat-no" title="statement not covered" >      const {</span>
<span class="cstat-no" title="statement not covered" >        userAttributes,</span>
...
<span class="cstat-no" title="statement not covered" >        cachebust,</span>
<span class="cstat-no" title="statement not covered" >        noCache,</span>
<span class="cstat-no" title="statement not covered" >        preview,</span>
<span class="cstat-no" title="statement not covered" >        editing,</span>
<span class="cstat-no" title="statement not covered" >        frameEditing,</span>
<span class="cstat-no" title="statement not covered" >        options,</span>
<span class="cstat-no" title="statement not covered" >        params: overrideParams,</span>
<span class="cstat-no" title="statement not covered" >      } = builder;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (userAttributes) {</span>
<span class="cstat-no" title="statement not covered" >        this.setUserAttributes(userAttributes);</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (options) {</span>
<span class="cstat-no" title="statement not covered" >        // picking only locale and includeRefs</span>
<span class="cstat-no" title="statement not covered" >        this.queryOptions = {</span>
<span class="cstat-no" title="statement not covered" >          ...(options.locale &amp;&amp; { locale: options.locale }),</span>
<span class="cstat-no" title="statement not covered" >          ...(options.includeRefs &amp;&amp; { includeRefs: options.includeRefs }),</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (overrides) {</span>
<span class="cstat-no" title="statement not covered" >        this.overrides = overrides;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (validEnvList.indexOf(env || api) &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >        this.env = env || api;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (Builder.isEditing) {</span>
<span class="cstat-no" title="statement not covered" >        const editingModel = frameEditing || editing || preview;</span>
<span class="cstat-no" title="statement not covered" >        if (editingModel &amp;&amp; editingModel !== 'true') {</span>
<span class="cstat-no" title="statement not covered" >          this.editingModel = editingModel;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (cachebust) {</span>
<span class="cstat-no" title="statement not covered" >        this.cachebust = true;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (noCache) {</span>
<span class="cstat-no" title="statement not covered" >        this.noCache = true;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (preview) {</span>
<span class="cstat-no" title="statement not covered" >        this.preview = true;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (params) {</span>
<span class="cstat-no" title="statement not covered" >        this.overrideParams = overrideParams;</span>
      }
    }
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >messageFrameLoaded() {</span>
<span class="cstat-no" title="statement not covered" >    window.parent?.postMessage(</span>
<span class="cstat-no" title="statement not covered" >      {</span>
<span class="cstat-no" title="statement not covered" >        type: 'builder.loaded',</span>
<span class="cstat-no" title="statement not covered" >        data: {</span>
...
&nbsp;
  private <span class="fstat-no" title="function not covered" >bindMessageListeners() {</span>
<span class="cstat-no" title="statement not covered" >    if (isBrowser) {</span>
<span class="cstat-no" title="statement not covered" >      addEventListener('message', event =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const url = parse(event.origin);</span>
<span class="cstat-no" title="statement not covered" >        const isRestricted =</span>
<span class="cstat-no" title="statement not covered" >          ['builder.register', 'builder.registerComponent'].indexOf(event.data?.type) === -1;</span>
<span class="cstat-no" title="statement not covered" >        const isTrusted = url.hostname &amp;&amp; Builder.isTrustedHost(url.hostname);</span>
<span class="cstat-no" title="statement not covered" >        if (isRestricted &amp;&amp; !isTrusted) {</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        const { data } = event;</span>
...
<span class="cstat-no" title="statement not covered" >            case 'builder.ping': {</span>
<span class="cstat-no" title="statement not covered" >              window.parent?.postMessage(</span>
<span class="cstat-no" title="statement not covered" >                {</span>
<span class="cstat-no" title="statement not covered" >                  type: 'builder.pong',</span>
<span class="cstat-no" title="statement not covered" >                  data: {},</span>
<span class="cstat-no" title="statement not covered" >                },</span>
<span class="cstat-no" title="statement not covered" >                '*'</span>
<span class="cstat-no" title="statement not covered" >              );</span>
...
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            case 'builder.register': {</span>
<span class="cstat-no" title="statement not covered" >              // TODO: possibly do this for all...</span>
<span class="cstat-no" title="statement not covered" >              if (event.source === window) {</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              const options = data.data;</span>
<span class="cstat-no" title="statement not covered" >              if (!options) {</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              const { type, info } = options;</span>
<span class="cstat-no" title="statement not covered" >              // TODO: all must have name and can't conflict?</span>
<span class="cstat-no" title="statement not covered" >              let typeList = Builder.registry[type];</span>
<span class="cstat-no" title="statement not covered" >              if (!typeList) {</span>
<span class="cstat-no" title="statement not covered" >                typeList = Builder.registry[type] = [];</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              typeList.push(info);</span>
<span class="cstat-no" title="statement not covered" >              Builder.registryChange.next(Builder.registry);</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            case 'builder.settingsChange': {</span>
<span class="cstat-no" title="statement not covered" >              // TODO: possibly do this for all...</span>
<span class="cstat-no" title="statement not covered" >              if (event.source === window) {</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              const settings = data.data;</span>
<span class="cstat-no" title="statement not covered" >              if (!settings) {</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              Object.assign(Builder.settings, settings);</span>
<span class="cstat-no" title="statement not covered" >              Builder.settingsChange.next(Builder.settings);</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            case 'builder.registerEditor': {</span>
<span class="cstat-no" title="statement not covered" >              // TODO: possibly do this for all...</span>
<span class="cstat-no" title="statement not covered" >              if (event.source === window) {</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              const info = data.data;</span>
<span class="cstat-no" title="statement not covered" >              if (!info) {</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              const hasComponent = !!info.component;</span>
<span class="cstat-no" title="statement not covered" >              Builder.editors.every((thisInfo, index) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                if (info.name === thisInfo.name) {</span>
<span class="cstat-no" title="statement not covered" >                  if (thisInfo.component &amp;&amp; !hasComponent) {</span>
<span class="cstat-no" title="statement not covered" >                    return false;</span>
<span class="cstat-no" title="statement not covered" >                  } else {</span>
<span class="cstat-no" title="statement not covered" >                    Builder.editors[index] = thisInfo;</span>
<span class="cstat-no" title="statement not covered" >                  }</span>
<span class="cstat-no" title="statement not covered" >                  return false;</span>
<span class="cstat-no" title="statement not covered" >                }</span>
...
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            case 'builder.triggerAnimation': {</span>
<span class="cstat-no" title="statement not covered" >              Builder.animator.triggerAnimation(data.data);</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            case 'builder.contentUpdate':</span>
<span class="cstat-no" title="statement not covered" >              const key =</span>
<span class="cstat-no" title="statement not covered" >                data.data.key || data.data.alias || data.data.entry || data.data.modelName;</span>
<span class="cstat-no" title="statement not covered" >              const contentData = data.data.data; // hmmm...</span>
<span class="cstat-no" title="statement not covered" >              const observer = this.observersByKey[key];</span>
<span class="cstat-no" title="statement not covered" >              if (observer &amp;&amp; !this.noEditorUpdates[key]) {</span>
<span class="cstat-no" title="statement not covered" >                observer.next([contentData]);</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            case 'builder.getComponents':</span>
<span class="cstat-no" title="statement not covered" >              window.parent?.postMessage(</span>
<span class="cstat-no" title="statement not covered" >                {</span>
<span class="cstat-no" title="statement not covered" >                  type: 'builder.components',</span>
<span class="cstat-no" title="statement not covered" >                  data: Builder.components.map(item =&gt; Builder.prepareComponentSpecToSend(item)),</span>
<span class="cstat-no" title="statement not covered" >                },</span>
<span class="cstat-no" title="statement not covered" >                '*'</span>
<span class="cstat-no" title="statement not covered" >              );</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            case 'builder.editingModel':</span>
<span class="cstat-no" title="statement not covered" >              this.editingModel = data.data.model;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            case 'builder.registerComponent':</span>
<span class="cstat-no" title="statement not covered" >              const componentData = data.data;</span>
<span class="cstat-no" title="statement not covered" >              Builder.addComponent(componentData);</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            case 'builder.blockContentLoading':</span>
<span class="cstat-no" title="statement not covered" >              if (typeof data.data.model === 'string') {</span>
<span class="cstat-no" title="statement not covered" >                this.blockContentLoading = data.data.model;</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            case 'builder.editingMode':</span>
<span class="cstat-no" title="statement not covered" >              const editingMode = data.data;</span>
<span class="cstat-no" title="statement not covered" >              if (editingMode) {</span>
<span class="cstat-no" title="statement not covered" >                this.editingMode = true;</span>
<span class="cstat-no" title="statement not covered" >                document.body.classList.add('builder-editing');</span>
<span class="cstat-no" title="statement not covered" >              } else {</span>
<span class="cstat-no" title="statement not covered" >                this.editingMode = false;</span>
<span class="cstat-no" title="statement not covered" >                document.body.classList.remove('builder-editing');</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            case 'builder.editingPageMode':</span>
<span class="cstat-no" title="statement not covered" >              const editingPageMode = data.data;</span>
<span class="cstat-no" title="statement not covered" >              Builder.editingPage = editingPageMode;</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            case 'builder.overrideUserAttributes':</span>
<span class="cstat-no" title="statement not covered" >              const userAttributes = data.data;</span>
<span class="cstat-no" title="statement not covered" >              assign(Builder.overrideUserAttributes, userAttributes);</span>
<span class="cstat-no" title="statement not covered" >              this.flushGetContentQueue(true);</span>
<span class="cstat-no" title="statement not covered" >              // TODO: refetch too</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            case 'builder.overrideTestGroup':</span>
<span class="cstat-no" title="statement not covered" >              const { variationId, contentId } = data.data;</span>
<span class="cstat-no" title="statement not covered" >              if (variationId &amp;&amp; contentId) {</span>
<span class="cstat-no" title="statement not covered" >                this.setTestCookie(contentId, variationId);</span>
<span class="cstat-no" title="statement not covered" >                this.flushGetContentQueue(true);</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              break;</span>
<span class="cstat-no" title="statement not covered" >            case 'builder.evaluate': {</span>
<span class="cstat-no" title="statement not covered" >              const text = data.data.text;</span>
<span class="cstat-no" title="statement not covered" >              const args = data.data.arguments || [];</span>
<span class="cstat-no" title="statement not covered" >              const id = data.data.id;</span>
<span class="cstat-no" title="statement not covered" >              // tslint:disable-next-line:no-function-constructor-with-string-args</span>
<span class="cstat-no" title="statement not covered" >              const fn = new Function(text);</span>
<span class="cstat-no" title="statement not covered" >              let result: any;</span>
<span class="cstat-no" title="statement not covered" >              let error: Error | null = null;</span>
<span class="cstat-no" title="statement not covered" >              try {</span>
<span class="cstat-no" title="statement not covered" >                result = fn.apply(this, args);</span>
<span class="cstat-no" title="statement not covered" >              } catch (err) {</span>
<span class="cstat-no" title="statement not covered" >                error = toError(err);</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >              if (error) {</span>
<span class="cstat-no" title="statement not covered" >                window.parent?.postMessage(</span>
<span class="cstat-no" title="statement not covered" >                  {</span>
<span class="cstat-no" title="statement not covered" >                    type: 'builder.evaluateError',</span>
<span class="cstat-no" title="statement not covered" >                    data: { id, error: error.message },</span>
<span class="cstat-no" title="statement not covered" >                  },</span>
<span class="cstat-no" title="statement not covered" >                  '*'</span>
<span class="cstat-no" title="statement not covered" >                );</span>
<span class="cstat-no" title="statement not covered" >              } else {</span>
<span class="cstat-no" title="statement not covered" >                if (result &amp;&amp; typeof result.then === 'function') {</span>
<span class="cstat-no" title="statement not covered" >                  (result as Promise&lt;any&gt;)</span>
<span class="cstat-no" title="statement not covered" >                    .then(finalResult =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                      window.parent?.postMessage(</span>
<span class="cstat-no" title="statement not covered" >                        {</span>
<span class="cstat-no" title="statement not covered" >                          type: 'builder.evaluateResult',</span>
<span class="cstat-no" title="statement not covered" >                          data: { id, result: finalResult },</span>
<span class="cstat-no" title="statement not covered" >                        },</span>
<span class="cstat-no" title="statement not covered" >                        '*'</span>
<span class="cstat-no" title="statement not covered" >                      );</span>
<span class="cstat-no" title="statement not covered" >                    })</span>
<span class="cstat-no" title="statement not covered" >                    .catch(console.error);</span>
<span class="cstat-no" title="statement not covered" >                } else {</span>
<span class="cstat-no" title="statement not covered" >                  window.parent?.postMessage(</span>
<span class="cstat-no" title="statement not covered" >                    {</span>
<span class="cstat-no" title="statement not covered" >                      type: 'builder.evaluateResult',</span>
<span class="cstat-no" title="statement not covered" >                      data: { result, id },</span>
<span class="cstat-no" title="statement not covered" >                    },</span>
<span class="cstat-no" title="statement not covered" >                    '*'</span>
<span class="cstat-no" title="statement not covered" >                  );</span>
<span class="cstat-no" title="statement not covered" >                }</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >              break;</span></span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >          }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >      });</span>
...
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  observersByKey: { [key: string]: BehaviorSubject&lt;BuilderContent[]&gt; | undefined } = {};</span>
<span class="cstat-no" title="statement not covered" >  noEditorUpdates: { [key: string]: boolean } = {};</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  get defaultCanTrack() {</span>
<span class="cstat-no" title="statement not covered" >    return Boolean(</span>
<span class="cstat-no" title="statement not covered" >      Builder.isBrowser &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >        navigator.userAgent.trim() &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >        !navigator.userAgent.match(</span>
<span class="cstat-no" title="statement not covered" >          /bot|crawler|spider|robot|crawling|prerender|google|baidu|bing|msn|duckduckbot|teoma|slurp|yandex|phantom|headless|selenium|puppeteer/i</span>
<span class="cstat-no" title="statement not covered" >        ) &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >        !this.browserTrackingDisabled</span>
    );
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  init(</span>
<span class="cstat-no" title="statement not covered" >    apiKey: string,</span>
<span class="cstat-no" title="statement not covered" >    canTrack = this.defaultCanTrack,</span>
<span class="cstat-no" title="statement not covered" >    req?: IncomingMessage,</span>
<span class="cstat-no" title="statement not covered" >    res?: ServerResponse,</span>
<span class="cstat-no" title="statement not covered" >    authToken?: string | null,</span>
<span class="cstat-no" title="statement not covered" >    apiVersion?: ApiVersion</span>
<span class="cstat-no" title="statement not covered" >  ) {</span>
...
<span class="cstat-no" title="statement not covered" >      this.response = res;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    this.canTrack = canTrack;</span>
<span class="cstat-no" title="statement not covered" >    this.apiKey = apiKey;</span>
<span class="cstat-no" title="statement not covered" >    if (authToken) {</span>
<span class="cstat-no" title="statement not covered" >      this.authToken = authToken;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
<span class="cstat-no" title="statement not covered" >      this.apiVersion = apiVersion;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >this;</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  get previewingModel() {</span>
<span class="cstat-no" title="statement not covered" >    const search = this.getLocation().search;</span>
<span class="cstat-no" title="statement not covered" >    const params = QueryString.parse((search || '').substr(1));</span>
<span class="cstat-no" title="statement not covered" >    return params['builder.preview'];</span>
  }
&nbsp;
  // TODO: allow adding location object as property and/or in constructor
<span class="fstat-no" title="function not covered" >  getLocation(): Url {</span>
<span class="cstat-no" title="statement not covered" >    let parsedLocation: any = {};</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // in ssr mode</span>
<span class="cstat-no" title="statement not covered" >    if (this.request) {</span>
<span class="cstat-no" title="statement not covered" >      parsedLocation = parse(this.request.url ?? '');</span>
<span class="cstat-no" title="statement not covered" >    } else if (typeof location === 'object') {</span>
<span class="cstat-no" title="statement not covered" >      // in the browser</span>
<span class="cstat-no" title="statement not covered" >      parsedLocation = parse(location.href);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // IE11 bug with parsed path being empty string</span>
<span class="cstat-no" title="statement not covered" >    // causes issues with our user targeting</span>
<span class="cstat-no" title="statement not covered" >    if (parsedLocation.pathname === '') {</span>
<span class="cstat-no" title="statement not covered" >      parsedLocation.pathname = '/';</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    return parsedLocation;</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getUserAttributes(userAgent = this.userAgent || '') {</span>
<span class="cstat-no" title="statement not covered" >    const isMobile = {</span>
<span class="cstat-no" title="statement not covered" >      Android() {</span>
<span class="cstat-no" title="statement not covered" >        return userAgent.match(/Android/i);</span>
<span class="cstat-no" title="statement not covered" >      },</span>
<span class="cstat-no" title="statement not covered" >      BlackBerry() {</span>
<span class="cstat-no" title="statement not covered" >        return userAgent.match(/BlackBerry/i);</span>
<span class="cstat-no" title="statement not covered" >      },</span>
<span class="cstat-no" title="statement not covered" >      iOS() {</span>
<span class="cstat-no" title="statement not covered" >        return userAgent.match(/iPhone|iPod/i);</span>
<span class="cstat-no" title="statement not covered" >      },</span>
<span class="cstat-no" title="statement not covered" >      Opera() {</span>
<span class="cstat-no" title="statement not covered" >        return userAgent.match(/Opera Mini/i);</span>
<span class="cstat-no" title="statement not covered" >      },</span>
<span class="cstat-no" title="statement not covered" >      Windows() {</span>
<span class="cstat-no" title="statement not covered" >        return userAgent.match(/IEMobile/i) || userAgent.match(/WPDesktop/i);</span>
<span class="cstat-no" title="statement not covered" >      },</span>
<span class="cstat-no" title="statement not covered" >      any() {</span>
<span class="cstat-no" title="statement not covered" >        return (</span>
<span class="cstat-no" title="statement not covered" >          isMobile.Android() ||</span>
<span class="cstat-no" title="statement not covered" >          isMobile.BlackBerry() ||</span>
<span class="cstat-no" title="statement not covered" >          isMobile.iOS() ||</span>
<span class="cstat-no" title="statement not covered" >          isMobile.Opera() ||</span>
<span class="cstat-no" title="statement not covered" >          isMobile.Windows()</span>
<span class="cstat-no" title="statement not covered" >        );</span>
<span class="cstat-no" title="statement not covered" >      },</span>
<span class="cstat-no" title="statement not covered" >    };</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const isTablet = userAgent.match(/Tablet|iPad/i);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const url = this.getLocation();</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    return {</span>
<span class="cstat-no" title="statement not covered" >      urlPath: url.pathname,</span>
<span class="cstat-no" title="statement not covered" >      host: url.host || url.hostname,</span>
<span class="cstat-no" title="statement not covered" >      // TODO: maybe an option to choose to target off of mobile/tablet/desktop or just mobile/desktop</span>
<span class="cstat-no" title="statement not covered" >      device: isTablet ? 'tablet' : isMobile.any() ? 'mobile' : 'desktop',</span>
<span class="cstat-no" title="statement not covered" >      ...Builder.overrideUserAttributes,</span>
    } as UserAttributes;
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  setUserAttributes(options: object) {</span>
<span class="cstat-no" title="statement not covered" >    assign(Builder.overrideUserAttributes, options);</span>
<span class="cstat-no" title="statement not covered" >    this.userAttributesChanged.next(options);</span>
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  setTrackingUserAttributes(attributes: object) {</span>
<span class="cstat-no" title="statement not covered" >    assign(this.trackingUserAttributes, attributes);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  get(</span>
<span class="cstat-no" title="statement not covered" >    modelName: string,</span>
<span class="cstat-no" title="statement not covered" >    options: GetContentOptions &amp; {</span>
<span class="cstat-no" title="statement not covered" >      req?: IncomingMessage;</span>
<span class="cstat-no" title="statement not covered" >      res?: ServerResponse;</span>
<span class="cstat-no" title="statement not covered" >      apiKey?: string;</span>
<span class="cstat-no" title="statement not covered" >      authToken?: string;</span>
<span class="cstat-no" title="statement not covered" >    } = {}</span>
<span class="cstat-no" title="statement not covered" >  ) {</span>
<span class="cstat-no" title="statement not covered" >    let instance: Builder = this;</span>
<span class="cstat-no" title="statement not covered" >    if (!Builder.isBrowser) {</span>
<span class="cstat-no" title="statement not covered" >      instance = new Builder(</span>
<span class="cstat-no" title="statement not covered" >        options.apiKey || this.apiKey,</span>
<span class="cstat-no" title="statement not covered" >        options.req,</span>
<span class="cstat-no" title="statement not covered" >        options.res,</span>
<span class="cstat-no" title="statement not covered" >        undefined,</span>
<span class="cstat-no" title="statement not covered" >        options.authToken || this.authToken,</span>
<span class="cstat-no" title="statement not covered" >        options.apiVersion || this.apiVersion</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" >      instance.setUserAttributes(this.getUserAttributes());</span>
<span class="cstat-no" title="statement not covered" >    } else {</span>
<span class="cstat-no" title="statement not covered" >      // NOTE: All these are when .init is not called and the customer</span>
<span class="cstat-no" title="statement not covered" >      // directly calls .get on the singleton instance of Builder</span>
<span class="cstat-no" title="statement not covered" >      if (options.apiKey &amp;&amp; !this.apiKey) {</span>
<span class="cstat-no" title="statement not covered" >        this.apiKey = options.apiKey;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      if (options.authToken &amp;&amp; !this.authToken) {</span>
<span class="cstat-no" title="statement not covered" >        this.authToken = options.authToken;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      if (options.apiVersion &amp;&amp; !this.apiVersion) {</span>
<span class="cstat-no" title="statement not covered" >        this.apiVersion = options.apiVersion;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return instance.queueGetContent(modelName, options).map(</span>
<span class="cstat-no" title="statement not covered" >      /* map( */ (matches: any[] | null) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const match = matches &amp;&amp; matches[0];</span>
<span class="cstat-no" title="statement not covered" >        if (Builder.isStatic) {</span>
<span class="cstat-no" title="statement not covered" >          return match;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        const matchData = match &amp;&amp; match.data;</span>
<span class="cstat-no" title="statement not covered" >        if (!matchData) {</span>
<span class="cstat-no" title="statement not covered" >          return null;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        if (typeof matchData.blocksString !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >          matchData.blocks = JSON.parse(matchData.blocksString);</span>
<span class="cstat-no" title="statement not covered" >          delete matchData.blocksString;</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >        return {</span>
<span class="cstat-no" title="statement not covered" >          // TODO: add ab test info here and other high level stuff</span>
<span class="cstat-no" title="statement not covered" >          data: matchData,</span>
<span class="cstat-no" title="statement not covered" >          id: match.id,</span>
<span class="cstat-no" title="statement not covered" >          variationId: match.testVariationId || match.variationId || null,</span>
<span class="cstat-no" title="statement not covered" >          testVariationId: match.testVariationId || match.variationId || null,</span>
<span class="cstat-no" title="statement not covered" >          testVariationName: match.testVariationName || null,</span>
<span class="cstat-no" title="statement not covered" >          lastUpdated: match.lastUpdated || null,</span>
        };
      }
    );
    // );
...
<span class="fstat-no" title="function not covered" >  queueGetContent(modelName: string, options: GetContentOptions = {}) {</span>
<span class="cstat-no" title="statement not covered" >    // TODO: if query do modelName + query</span>
<span class="cstat-no" title="statement not covered" >    const key =</span>
<span class="cstat-no" title="statement not covered" >      options.key ||</span>
<span class="cstat-no" title="statement not covered" >      options.alias ||</span>
<span class="cstat-no" title="statement not covered" >      // TODO: SDKs only pass entry key when given to them, and never when editing...</span>
<span class="cstat-no" title="statement not covered" >      // options.entry ||</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      // TODO: this is ugly - instead of multiple of same model with different options are sent</span>
<span class="cstat-no" title="statement not covered" >      // say requires key/alias. Or if not perhaps make a reliable hash of the options and use that.</span>
<span class="cstat-no" title="statement not covered" >      // TODO: store last user state on last request and if user attributes different now</span>
<span class="cstat-no" title="statement not covered" >      // give a warning that need to use keys to request new contente</span>
<span class="cstat-no" title="statement not covered" >      // (options &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >      //   Object.keys(options).filter(key =&gt; key !== 'model').length &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >      //   JSON.stringify({ model: modelName, ...options, initialContent: undefined })) ||</span>
<span class="cstat-no" title="statement not covered" >      modelName;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const isEditingThisModel = this.editingModel === modelName;</span>
<span class="cstat-no" title="statement not covered" >    // TODO: include params in this key........</span>
<span class="cstat-no" title="statement not covered" >    const currentObservable = this.observersByKey[key] as BehaviorSubject&lt;BuilderContent[]&gt; | null;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // if (options.query &amp;&amp; options.query._id) {</span>
<span class="cstat-no" title="statement not covered" >    //   this.flushGetContentQueue([options])</span>
<span class="cstat-no" title="statement not covered" >    // }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (this.apiKey === 'DEMO' &amp;&amp; !this.overrides[key] &amp;&amp; !options.initialContent) {</span>
<span class="cstat-no" title="statement not covered" >      options.initialContent = [];</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const { initialContent } = options;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // TODO: refresh option in options</span>
<span class="cstat-no" title="statement not covered" >    if (currentObservable &amp;&amp; (!currentObservable.value || options.cache)) {</span>
<span class="cstat-no" title="statement not covered" >      // TODO: test if this ran, otherwise on 404 some observers may never be called...</span>
<span class="cstat-no" title="statement not covered" >      if (currentObservable.value) {</span>
<span class="cstat-no" title="statement not covered" >        nextTick(() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          // TODO: return a new observable and only that one fires subscribers, don't refire for existing ones</span>
<span class="cstat-no" title="statement not covered" >          currentObservable.next(currentObservable.value);</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      return currentObservable;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    if (isEditingThisModel) {</span>
<span class="cstat-no" title="statement not covered" >      if (Builder.isBrowser) {</span>
<span class="cstat-no" title="statement not covered" >        parent.postMessage({ type: 'builder.updateContent', data: { options } }, '*');</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    if (!initialContent /* || isEditingThisModel */) {</span>
<span class="cstat-no" title="statement not covered" >      if (!this.getContentQueue) {</span>
<span class="cstat-no" title="statement not covered" >        this.getContentQueue = [];</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      this.getContentQueue.push({ ...options, model: modelName, key });</span>
<span class="cstat-no" title="statement not covered" >      if (this.getContentQueue &amp;&amp; this.getContentQueue.length &gt;= this.contentPerRequest) {</span>
<span class="cstat-no" title="statement not covered" >        const queue = this.getContentQueue.slice();</span>
<span class="cstat-no" title="statement not covered" >        this.getContentQueue = [];</span>
<span class="cstat-no" title="statement not covered" >        nextTick(() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          this.flushGetContentQueue(false, queue);</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >      } else {</span>
<span class="cstat-no" title="statement not covered" >        nextTick(() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          this.flushGetContentQueue();</span>
<span class="cstat-no" title="statement not covered" >        });</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const observable = new BehaviorSubject&lt;BuilderContent[]&gt;(null as any);</span>
<span class="cstat-no" title="statement not covered" >    this.observersByKey[key] = observable;</span>
<span class="cstat-no" title="statement not covered" >    if (options.noEditorUpdates) {</span>
<span class="cstat-no" title="statement not covered" >      this.noEditorUpdates[key] = true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    if (initialContent) {</span>
<span class="cstat-no" title="statement not covered" >      nextTick(() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        // TODO: need to testModify this I think...?</span>
<span class="cstat-no" title="statement not covered" >        observable.next(initialContent);</span>
<span class="cstat-no" title="statement not covered" >      });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
...
<span class="fstat-no" title="function not covered" >  requestUrl(</span>
<span class="cstat-no" title="statement not covered" >    url: string,</span>
<span class="cstat-no" title="statement not covered" >    options?: { headers: { [header: string]: number | string | string[] | undefined } }</span>
<span class="cstat-no" title="statement not covered" >  ) {</span>
<span class="cstat-no" title="statement not covered" >    return getFetch()(url, options as SimplifiedFetchOptions).then(res =&gt; res.<span class="fstat-no" title="function not covered" >json());</span></span>
<span class="cstat-no" title="statement not covered" >  }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >  get host() {</span>
<span class="cstat-no" title="statement not covered" >    switch (this.env) {</span>
<span class="cstat-no" title="statement not covered" >      case 'qa':</span>
<span class="cstat-no" title="statement not covered" >        return 'https://qa.builder.io';</span>
<span class="cstat-no" title="statement not covered" >      case 'test':</span>
<span class="cstat-no" title="statement not covered" >        return 'https://builder-io-test.web.app';</span>
<span class="cstat-no" title="statement not covered" >      case 'fast':</span>
<span class="cstat-no" title="statement not covered" >        return 'https://fast.builder.io';</span>
<span class="cstat-no" title="statement not covered" >      case 'cloud':</span>
<span class="cstat-no" title="statement not covered" >        return 'https://cloud.builder.io';</span>
<span class="cstat-no" title="statement not covered" >      case 'cdn2':</span>
<span class="cstat-no" title="statement not covered" >        return 'https://cdn2.builder.io';</span>
<span class="cstat-no" title="statement not covered" >      case 'cdn-qa':</span>
<span class="cstat-no" title="statement not covered" >        return 'https://cdn-qa.builder.io';</span>
<span class="cstat-no" title="statement not covered" >      case 'development':</span>
<span class="cstat-no" title="statement not covered" >      case 'dev':</span>
<span class="cstat-no" title="statement not covered" >        return 'http://localhost:5000';</span>
<span class="cstat-no" title="statement not covered" >      case 'cdn-prod':</span>
<span class="cstat-no" title="statement not covered" >        return 'https://cdn.builder.io';</span>
<span class="cstat-no" title="statement not covered" >      default:</span>
<span class="cstat-no" title="statement not covered" >        return Builder.overrideHost || 'https://cdn.builder.io';</span>
    }
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >flushGetContentQueue(usePastQueue = false, useQueue?: GetContentOptions[]) {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.apiKey) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
<span class="cstat-no" title="statement not covered" >        `Fetching content failed, expected apiKey to be defined instead got: ${this.apiKey}`</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (this.apiVersion) {</span>
<span class="cstat-no" title="statement not covered" >      if (!['v1', 'v3'].includes(this.apiVersion)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error(`Invalid apiVersion: expected 'v1' or 'v3', received '${this.apiVersion}'`);</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    } else {</span>
<span class="cstat-no" title="statement not covered" >      this.apiVersion = DEFAULT_API_VERSION;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (!usePastQueue &amp;&amp; !this.getContentQueue) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const queue = useQueue || (usePastQueue ? this.priorContentQueue : this.getContentQueue) || [];</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // TODO: do this on every request send?</span>
<span class="cstat-no" title="statement not covered" >    this.getOverridesFromQueryString();</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const queryParams: ParamsMap = {</span>
<span class="cstat-no" title="statement not covered" >      // TODO: way to force a request to be in a separate queue. or just lower queue limit to be 1 by default</span>
<span class="cstat-no" title="statement not covered" >      omit: queue[0].omit || 'meta.componentsUsed',</span>
<span class="cstat-no" title="statement not covered" >      apiKey: this.apiKey,</span>
<span class="cstat-no" title="statement not covered" >      ...queue[0].options,</span>
<span class="cstat-no" title="statement not covered" >      ...this.queryOptions,</span>
<span class="cstat-no" title="statement not covered" >    };</span>
<span class="cstat-no" title="statement not covered" >    if (queue[0].fields) {</span>
<span class="cstat-no" title="statement not covered" >      queryParams.fields = queue[0].fields;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    if (queue[0].format) {</span>
<span class="cstat-no" title="statement not covered" >      queryParams.format = queue[0].format;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const pageQueryParams: ParamsMap =</span>
<span class="cstat-no" title="statement not covered" >      typeof location !== 'undefined'</span>
<span class="cstat-no" title="statement not covered" >        ? QueryString.parseDeep(location.search.substr(1))</span>
<span class="cstat-no" title="statement not covered" >        : undefined || {};</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const userAttributes =</span>
<span class="cstat-no" title="statement not covered" >      // FIXME: HACK: only checks first in queue for user attributes overrides, should check all</span>
<span class="cstat-no" title="statement not covered" >      // TODO: merge user attributes provided here with defaults and current user attiributes (?)</span>
<span class="cstat-no" title="statement not covered" >      queue &amp;&amp; queue[0].userAttributes</span>
<span class="cstat-no" title="statement not covered" >        ? queue[0].userAttributes</span>
<span class="cstat-no" title="statement not covered" >        : this.targetContent</span>
<span class="cstat-no" title="statement not covered" >        ? this.getUserAttributes()</span>
<span class="cstat-no" title="statement not covered" >        : {</span>
<span class="cstat-no" title="statement not covered" >            urlPath: this.getLocation().pathname,</span>
<span class="cstat-no" title="statement not covered" >          };</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const fullUrlQueueItem = queue.find(item =&gt; !!item.includeUrl);</span>
<span class="cstat-no" title="statement not covered" >    if (fullUrlQueueItem) {</span>
<span class="cstat-no" title="statement not covered" >      const location = this.getLocation();</span>
<span class="cstat-no" title="statement not covered" >      if (location.origin) {</span>
<span class="cstat-no" title="statement not covered" >        queryParams.url = `${location.origin}${location.pathname}${location.search}`;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const urlQueueItem = useQueue?.find(item =&gt; item.url);</span>
<span class="cstat-no" title="statement not covered" >    if (urlQueueItem?.url) {</span>
<span class="cstat-no" title="statement not covered" >      userAttributes.urlPath = urlQueueItem.url.split('?')[0];</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    // TODO: merge in the attribute from query string ones</span>
<span class="cstat-no" title="statement not covered" >    // TODO: make this an option per component/request</span>
<span class="cstat-no" title="statement not covered" >    queryParams.userAttributes = userAttributes;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (!usePastQueue &amp;&amp; !useQueue) {</span>
<span class="cstat-no" title="statement not covered" >      this.priorContentQueue = queue;</span>
<span class="cstat-no" title="statement not covered" >      this.getContentQueue = null;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const cachebust =</span>
<span class="cstat-no" title="statement not covered" >      this.cachebust ||</span>
<span class="cstat-no" title="statement not covered" >      isIframe ||</span>
<span class="cstat-no" title="statement not covered" >      pageQueryParams.cachebust ||</span>
<span class="cstat-no" title="statement not covered" >      pageQueryParams['builder.cachebust'];</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (cachebust || this.env !== 'production') {</span>
<span class="cstat-no" title="statement not covered" >      queryParams.cachebust = true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (Builder.isEditing) {</span>
<span class="cstat-no" title="statement not covered" >      queryParams.isEditing = true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (this.noCache || this.env !== 'production') {</span>
<span class="cstat-no" title="statement not covered" >      queryParams.noCache = true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (size(this.overrides)) {</span>
<span class="cstat-no" title="statement not covered" >      for (const key in this.overrides) {</span>
<span class="cstat-no" title="statement not covered" >        if (this.overrides.hasOwnProperty(key)) {</span>
<span class="cstat-no" title="statement not covered" >          queryParams[`overrides.${key}`] = this.overrides[key];</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (!Builder.isReact) {</span>
<span class="cstat-no" title="statement not covered" >      // TODO: remove me once v1 page editors converted to v2</span>
<span class="cstat-no" title="statement not covered" >      // queryParams.extractCss = true;</span>
<span class="cstat-no" title="statement not covered" >      queryParams.prerender = true;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    for (const options of queue) {</span>
<span class="cstat-no" title="statement not covered" >      if (options.format) {</span>
<span class="cstat-no" title="statement not covered" >        queryParams.format = options.format;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      // TODO: remove me and make permodel</span>
<span class="cstat-no" title="statement not covered" >      if (options.static) {</span>
<span class="cstat-no" title="statement not covered" >        queryParams.static = options.static;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (options.cachebust) {</span>
<span class="cstat-no" title="statement not covered" >        queryParams.cachebust = options.cachebust;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (isPositiveNumber(options.cacheSeconds)) {</span>
<span class="cstat-no" title="statement not covered" >        queryParams.cacheSeconds = options.cacheSeconds;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      if (isPositiveNumber(options.staleCacheSeconds)) {</span>
<span class="cstat-no" title="statement not covered" >        queryParams.staleCacheSeconds = options.staleCacheSeconds;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >      const properties: (keyof GetContentOptions)[] = [</span>
<span class="cstat-no" title="statement not covered" >        'prerender',</span>
<span class="cstat-no" title="statement not covered" >        'extractCss',</span>
...
<span class="cstat-no" title="statement not covered" >        'rev',</span>
<span class="cstat-no" title="statement not covered" >        'static',</span>
<span class="cstat-no" title="statement not covered" >      ];</span>
<span class="cstat-no" title="statement not covered" >      for (const key of properties) {</span>
...
<span class="cstat-no" title="statement not covered" >          queryParams.options = queryParams.options || {};</span>
<span class="cstat-no" title="statement not covered" >          queryParams.options[options.key!] = queryParams.options[options.key!] || {};</span>
<span class="cstat-no" title="statement not covered" >          queryParams.options[options.key!][key] = JSON.stringify(value);</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    if (this.preview) {</span>
<span class="cstat-no" title="statement not covered" >      queryParams.preview = 'true';</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    const hasParams = Object.keys(queryParams).length &gt; 0;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // TODO: option to force dev or qa api here</span>
<span class="cstat-no" title="statement not covered" >    const host = this.host;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const keyNames = queue.map(item =&gt; encodeURIComponent(item.key!)).join(',');</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (this.overrideParams) {</span>
<span class="cstat-no" title="statement not covered" >      const params = omit(QueryString.parse(this.overrideParams), 'apiKey');</span>
<span class="cstat-no" title="statement not covered" >      assign(queryParams, params);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const queryStr = QueryString.stringifyDeep(queryParams);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const format = queryParams.format;</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const requestOptions = { headers: {} };</span>
<span class="cstat-no" title="statement not covered" >    if (this.authToken) {</span>
<span class="cstat-no" title="statement not covered" >      requestOptions.headers = {</span>
<span class="cstat-no" title="statement not covered" >        ...requestOptions.headers,</span>
<span class="cstat-no" title="statement not covered" >        Authorization: `Bearer ${this.authToken}`,</span>
<span class="cstat-no" title="statement not covered" >      };</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const fn = format === 'solid' || format === 'react' ? 'codegen' : 'query';</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // NOTE: this is a hack to get around the fact that the codegen endpoint is not yet available in v3</span>
<span class="cstat-no" title="statement not covered" >    const apiVersionBasedOnFn = fn === 'query' ? this.apiVersion : 'v1';</span>
<span class="cstat-no" title="statement not covered" >    const url =</span>
<span class="cstat-no" title="statement not covered" >      `${host}/api/${apiVersionBasedOnFn}/${fn}/${this.apiKey}/${keyNames}` +</span>
<span class="cstat-no" title="statement not covered" >      (queryParams &amp;&amp; hasParams ? `?${queryStr}` : '');</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    const promise = getFetch()(url, requestOptions)</span>
...
<span class="cstat-no" title="statement not covered" >          for (const options of queue) {</span>
<span class="cstat-no" title="statement not covered" >            const keyName = options.key!;</span>
<span class="cstat-no" title="statement not covered" >            if (options.model === this.blockContentLoading &amp;&amp; !options.noEditorUpdates) {</span>
<span class="cstat-no" title="statement not covered" >              continue;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >            const isEditingThisModel = this.editingModel === options.model;</span>
<span class="cstat-no" title="statement not covered" >            if (isEditingThisModel &amp;&amp; Builder.isEditing) {</span>
<span class="cstat-no" title="statement not covered" >              parent.postMessage({ type: 'builder.updateContent', data: { options } }, '*');</span>
<span class="cstat-no" title="statement not covered" >              // return;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            const observer = this.observersByKey[keyName];</span>
<span class="cstat-no" title="statement not covered" >            if (!observer) {</span>
<span class="cstat-no" title="statement not covered" >              return;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            const data = result[keyName];</span>
<span class="cstat-no" title="statement not covered" >            const sorted = data; // sortBy(data, item =&gt; item.priority);</span>
<span class="cstat-no" title="statement not covered" >            if (data) {</span>
<span class="cstat-no" title="statement not covered" >              const testModifiedResults = Builder.isServer</span>
<span class="cstat-no" title="statement not covered" >                ? sorted</span>
<span class="cstat-no" title="statement not covered" >                : this.processResultsForTests(sorted);</span>
<span class="cstat-no" title="statement not covered" >              observer.next(testModifiedResults);</span>
<span class="cstat-no" title="statement not covered" >            } else {</span>
<span class="cstat-no" title="statement not covered" >              const search = this.getLocation().search;</span>
<span class="cstat-no" title="statement not covered" >              if ((search || '').includes('builder.preview=' + options.model)) {</span>
<span class="cstat-no" title="statement not covered" >                const previewData = {</span>
<span class="cstat-no" title="statement not covered" >                  id: 'preview',</span>
<span class="cstat-no" title="statement not covered" >                  name: 'Preview',</span>
<span class="cstat-no" title="statement not covered" >                  data: {},</span>
<span class="cstat-no" title="statement not covered" >                };</span>
<span class="cstat-no" title="statement not covered" >                observer.next([previewData]);</span>
<span class="cstat-no" title="statement not covered" >              }</span>
<span class="cstat-no" title="statement not covered" >              observer.next([]);</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >          }</span>
<span class="cstat-no" title="statement not covered" >        },</span>
<span class="cstat-no" title="statement not covered" >        err =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          for (const options of queue) {</span>
<span class="cstat-no" title="statement not covered" >            const observer = this.observersByKey[options.key!];</span>
<span class="cstat-no" title="statement not covered" >            if (!observer) {</span>
<span class="cstat-no" title="statement not covered" >              return;</span>
<span class="cstat-no" title="statement not covered" >            }</span>
<span class="cstat-no" title="statement not covered" >            observer.error(err);</span>
<span class="cstat-no" title="statement not covered" >          }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" ></span>
...
&nbsp;
  private <span class="fstat-no" title="function not covered" >processResultsForTests(results: BuilderContent[]) {</span>
<span class="cstat-no" title="statement not covered" >    const mappedResults = results.map(item =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (!item.variations) {</span>
<span class="cstat-no" title="statement not covered" >        return item;</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      const cookieValue = this.getTestCookie(item.id!);</span>
<span class="cstat-no" title="statement not covered" >      const cookieVariation = cookieValue === item.id ? item : item.variations[cookieValue];</span>
<span class="cstat-no" title="statement not covered" >      if (cookieVariation) {</span>
<span class="cstat-no" title="statement not covered" >        return {</span>
<span class="cstat-no" title="statement not covered" >          ...item,</span>
<span class="cstat-no" title="statement not covered" >          data: cookieVariation.data,</span>
<span class="cstat-no" title="statement not covered" >          variationId: cookieValue,</span>
<span class="cstat-no" title="statement not covered" >          testVariationId: cookieValue,</span>
<span class="cstat-no" title="statement not covered" >          testVariationName: cookieVariation.name,</span>
<span class="cstat-no" title="statement not covered" >        };</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      if (this.canTrack &amp;&amp; item.variations &amp;&amp; size(item.variations)) {</span>
<span class="cstat-no" title="statement not covered" >        let n = 0;</span>
<span class="cstat-no" title="statement not covered" >        const random = Math.random();</span>
<span class="cstat-no" title="statement not covered" >        for (const id in item.variations) {</span>
<span class="cstat-no" title="statement not covered" >          const variation = item.variations[id]!;</span>
<span class="cstat-no" title="statement not covered" >          const testRatio = variation.testRatio;</span>
<span class="cstat-no" title="statement not covered" >          n += testRatio!;</span>
<span class="cstat-no" title="statement not covered" >          if (random &lt; n) {</span>
<span class="cstat-no" title="statement not covered" >            this.setTestCookie(item.id!, variation.id!);</span>
<span class="cstat-no" title="statement not covered" >            const variationName =</span>
<span class="cstat-no" title="statement not covered" >              variation.name || (variation.id === item.id ? 'Default variation' : '');</span>
<span class="cstat-no" title="statement not covered" >            return {</span>
<span class="cstat-no" title="statement not covered" >              ...item,</span>
<span class="cstat-no" title="statement not covered" >              data: variation.data,</span>
<span class="cstat-no" title="statement not covered" >              variationId: variation.id,</span>
<span class="cstat-no" title="statement not covered" >              testVariationId: variation.id,</span>
<span class="cstat-no" title="statement not covered" >              variationName: variationName,</span>
<span class="cstat-no" title="statement not covered" >              testVariationName: variationName,</span>
<span class="cstat-no" title="statement not covered" >            };</span>
<span class="cstat-no" title="statement not covered" >          }</span>
<span class="cstat-no" title="statement not covered" >        }</span>
<span class="cstat-no" title="statement not covered" >        this.setTestCookie(item.id!, item.id!);</span>
<span class="cstat-no" title="statement not covered" >      }</span>
<span class="cstat-no" title="statement not covered" >      return {</span>
<span class="cstat-no" title="statement not covered" >        ...item,</span>
<span class="cstat-no" title="statement not covered" >        variationId: item.id,</span>
<span class="cstat-no" title="statement not covered" >        ...(item.variations &amp;&amp;</span>
<span class="cstat-no" title="statement not covered" >          size(item.variations) &amp;&amp; {</span>
<span class="cstat-no" title="statement not covered" >            testVariationId: item.id,</span>
<span class="cstat-no" title="statement not covered" >            testVariationName: 'Default variation',</span>
<span class="cstat-no" title="statement not covered" >          }),</span>
<span class="cstat-no" title="statement not covered" >      };</span>
<span class="cstat-no" title="statement not covered" >    });</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    if (isIframe) {</span>
<span class="cstat-no" title="statement not covered" >      window.parent?.postMessage(</span>
<span class="cstat-no" title="statement not covered" >        { type: 'builder.contentResults', data: { results: mappedResults } },</span>
<span class="cstat-no" title="statement not covered" >        '*'</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    return mappedResults;</span>
  }
&nbsp;
  private <span class="fstat-no" title="function not covered" >getTestCookie(contentId: string) {</span>
<span class="cstat-no" title="statement not covered" >    return this.getCookie(`${this.testCookiePrefix}.${contentId}`);</span>
  }
&nbsp;
  private cookieQueue: [string, string][] = [];
&nbsp;
  private <span class="fstat-no" title="function not covered" >setTestCookie(contentId: string, variationId: string) {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.canTrack) {</span>
<span class="cstat-no" title="statement not covered" >      this.cookieQueue.push([contentId, variationId]);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    // 30 days from now</span>
<span class="cstat-no" title="statement not covered" >    const future = new Date();</span>
<span class="cstat-no" title="statement not covered" >    future.setDate(future.getDate() + 30);</span>
<span class="cstat-no" title="statement not covered" ></span>
<span class="cstat-no" title="statement not covered" >    return this.setCookie(`${this.testCookiePrefix}.${contentId}`, variationId, future);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getCookie(name: string): any {</span>
<span class="cstat-no" title="statement not covered" >    if (this.cookies) {</span>
<span class="cstat-no" title="statement not covered" >      return this.cookies.get(name);</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return Builder.isBrowser &amp;&amp; getCookie(name);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  setCookie(name: string, value: any, expires?: Date) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.cookies &amp;&amp; !(Builder.isServer &amp;&amp; Builder.isStatic)) {</span>
<span class="cstat-no" title="statement not covered" >      return this.cookies.set(name, value, {</span>
<span class="cstat-no" title="statement not covered" >        expires,</span>
<span class="cstat-no" title="statement not covered" >        secure: this.getLocation().protocol === 'https:',</span>
<span class="cstat-no" title="statement not covered" >      });</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return Builder.isBrowser &amp;&amp; setCookie(name, value, expires);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getContent(modelName: string, options: GetContentOptions = {}) {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.apiKey) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
<span class="cstat-no" title="statement not covered" >        `Fetching content from model ${modelName} failed, expected apiKey to be defined instead got: ${this.apiKey}`</span>
<span class="cstat-no" title="statement not covered" >      );</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="cstat-no" title="statement not covered" >    return this.queueGetContent(modelName, options);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  getAll(</span>
<span class="cstat-no" title="statement not covered" >    modelName: string,</span>
<span class="cstat-no" title="statement not covered" >    options: GetContentOptions &amp; {</span>
<span class="cstat-no" title="statement not covered" >      req?: IncomingMessage;</span>
<span class="cstat-no" title="statement not covered" >      res?: ServerResponse;</span>
<span class="cstat-no" title="statement not covered" >      apiKey?: string;</span>
<span class="cstat-no" title="statement not covered" >    } = {}</span>
<span class="cstat-no" title="statement not covered" >  ): Promise&lt;BuilderContent[]&gt; {</span>
<span class="cstat-no" title="statement not covered" >    let instance: Builder = this;</span>
<span class="cstat-no" title="statement not covered" >    if (!Builder.isBrowser) {</span>
<span class="cstat-no" title="statement not covered" >      instance = new Builder(</span>
<span class="cstat-no" title="statement not covered" >        options.apiKey || this.apiKey,</span>
...
<span class="cstat-no" title="statement not covered" >      .getContent(modelName, {</span>
<span class="cstat-no" title="statement not covered" >        limit: 30,</span>
<span class="cstat-no" title="statement not covered" >        ...options,</span>
<span class="cstat-no" title="statement not covered" >        key:</span>
<span class="cstat-no" title="statement not covered" >          options.key ||</span>
<span class="cstat-no" title="statement not covered" >          // Make the key include all options, so we don't reuse cache for the same content fetched</span>
<span class="cstat-no" title="statement not covered" >          // with different options</span>
<span class="cstat-no" title="statement not covered" >          Builder.isBrowser</span>
<span class="cstat-no" title="statement not covered" >            ? `${modelName}:${hash(omit(options, 'initialContent', 'req', 'res'))}`</span>
<span class="cstat-no" title="statement not covered" >            : undefined,</span>
<span class="cstat-no" title="statement not covered" >      })</span>
