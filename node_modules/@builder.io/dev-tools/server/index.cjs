"use strict";var Au=Object.create;var Ar=Object.defineProperty;var Pu=Object.getOwnPropertyDescriptor;var Tu=Object.getOwnPropertyNames;var Iu=Object.getPrototypeOf,Ru=Object.prototype.hasOwnProperty;var oe=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Bu=(e,t)=>{for(var n in t)Ar(e,n,{get:t[n],enumerable:!0})},Ki=(e,t,n,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let o of Tu(t))!Ru.call(e,o)&&o!==n&&Ar(e,o,{get:()=>t[o],enumerable:!(r=Pu(t,o))||r.enumerable});return e};var T=(e,t,n)=>(n=e!=null?Au(Iu(e)):{},Ki(t||!e||!e.__esModule?Ar(n,"default",{value:e,enumerable:!0}):n,e)),ku=e=>Ki(Ar({},"__esModule",{value:!0}),e);var qi=oe((Ld,Wi)=>{"use strict";Wi.exports=function(){if(process.env.npm_config_user_agent)return $u(process.env.npm_config_user_agent)};function $u(e){let t=e.split(" ")[0],n=t.lastIndexOf("/"),r=t.substring(0,n);return{name:r==="npminstall"?"cnpm":r,version:t.substring(n+1)}}});var Nr=oe((Cf,bo)=>{"use strict";var bn="\x1B",Y=`${bn}[`,Yu="\x07",Sn={to(e,t){return t?`${Y}${t+1};${e+1}H`:`${Y}${e+1}G`},move(e,t){let n="";return e<0?n+=`${Y}${-e}D`:e>0&&(n+=`${Y}${e}C`),t<0?n+=`${Y}${-t}A`:t>0&&(n+=`${Y}${t}B`),n},up:(e=1)=>`${Y}${e}A`,down:(e=1)=>`${Y}${e}B`,forward:(e=1)=>`${Y}${e}C`,backward:(e=1)=>`${Y}${e}D`,nextLine:(e=1)=>`${Y}E`.repeat(e),prevLine:(e=1)=>`${Y}F`.repeat(e),left:`${Y}G`,hide:`${Y}?25l`,show:`${Y}?25h`,save:`${bn}7`,restore:`${bn}8`},Qu={up:(e=1)=>`${Y}S`.repeat(e),down:(e=1)=>`${Y}T`.repeat(e)},Xu={screen:`${Y}2J`,up:(e=1)=>`${Y}1J`.repeat(e),down:(e=1)=>`${Y}J`.repeat(e),line:`${Y}2K`,lineEnd:`${Y}K`,lineStart:`${Y}1K`,lines(e){let t="";for(let n=0;n<e;n++)t+=this.line+(n<e-1?Sn.up():"");return e&&(t+=Sn.left),t}};bo.exports={cursor:Sn,scroll:Qu,erase:Xu,beep:Yu}});var et=oe((xf,vn)=>{var Lr=process||{},So=Lr.argv||[],$r=Lr.env||{},Zu=!($r.NO_COLOR||So.includes("--no-color"))&&(!!$r.FORCE_COLOR||So.includes("--color")||Lr.platform==="win32"||(Lr.stdout||{}).isTTY&&$r.TERM!=="dumb"||!!$r.CI),el=(e,t,n=e)=>r=>{let o=""+r,s=o.indexOf(t,e.length);return~s?e+tl(o,t,n,s)+t:e+o+t},tl=(e,t,n,r)=>{let o="",s=0;do o+=e.substring(s,r)+n,s=r+t.length,r=e.indexOf(t,s);while(~r);return o+e.substring(s)},vo=(e=Zu)=>{let t=e?el:()=>String;return{isColorSupported:e,reset:t("\x1B[0m","\x1B[0m"),bold:t("\x1B[1m","\x1B[22m","\x1B[22m\x1B[1m"),dim:t("\x1B[2m","\x1B[22m","\x1B[22m\x1B[2m"),italic:t("\x1B[3m","\x1B[23m"),underline:t("\x1B[4m","\x1B[24m"),inverse:t("\x1B[7m","\x1B[27m"),hidden:t("\x1B[8m","\x1B[28m"),strikethrough:t("\x1B[9m","\x1B[29m"),black:t("\x1B[30m","\x1B[39m"),red:t("\x1B[31m","\x1B[39m"),green:t("\x1B[32m","\x1B[39m"),yellow:t("\x1B[33m","\x1B[39m"),blue:t("\x1B[34m","\x1B[39m"),magenta:t("\x1B[35m","\x1B[39m"),cyan:t("\x1B[36m","\x1B[39m"),white:t("\x1B[37m","\x1B[39m"),gray:t("\x1B[90m","\x1B[39m"),bgBlack:t("\x1B[40m","\x1B[49m"),bgRed:t("\x1B[41m","\x1B[49m"),bgGreen:t("\x1B[42m","\x1B[49m"),bgYellow:t("\x1B[43m","\x1B[49m"),bgBlue:t("\x1B[44m","\x1B[49m"),bgMagenta:t("\x1B[45m","\x1B[49m"),bgCyan:t("\x1B[46m","\x1B[49m"),bgWhite:t("\x1B[47m","\x1B[49m"),blackBright:t("\x1B[90m","\x1B[39m"),redBright:t("\x1B[91m","\x1B[39m"),greenBright:t("\x1B[92m","\x1B[39m"),yellowBright:t("\x1B[93m","\x1B[39m"),blueBright:t("\x1B[94m","\x1B[39m"),magentaBright:t("\x1B[95m","\x1B[39m"),cyanBright:t("\x1B[96m","\x1B[39m"),whiteBright:t("\x1B[97m","\x1B[39m"),bgBlackBright:t("\x1B[100m","\x1B[49m"),bgRedBright:t("\x1B[101m","\x1B[49m"),bgGreenBright:t("\x1B[102m","\x1B[49m"),bgYellowBright:t("\x1B[103m","\x1B[49m"),bgBlueBright:t("\x1B[104m","\x1B[49m"),bgMagentaBright:t("\x1B[105m","\x1B[49m"),bgCyanBright:t("\x1B[106m","\x1B[49m"),bgWhiteBright:t("\x1B[107m","\x1B[49m")}};vn.exports=vo();vn.exports.createColors=vo});var ua=oe((px,Hr)=>{Hr.exports.Space_Separator=/[\u1680\u2000-\u200A\u202F\u205F\u3000]/;Hr.exports.ID_Start=/[\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0561-\u0587\u05D0-\u05EA\u05F0-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u08A0-\u08B4\u08B6-\u08BD\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C60\u0C61\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D05-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D5F-\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E87\u0E88\u0E8A\u0E8D\u0E94-\u0E97\u0E99-\u0E9F\u0EA1-\u0EA3\u0EA5\u0EA7\u0EAA\u0EAB\u0EAD-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16EE-\u16F8\u1700-\u170C\u170E-\u1711\u1720-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1877\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4B\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1C80-\u1C88\u1CE9-\u1CEC\u1CEE-\u1CF1\u1CF5\u1CF6\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2160-\u2188\u2C00-\u2C2E\u2C30-\u2C5E\u2C60-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005-\u3007\u3021-\u3029\u3031-\u3035\u3038-\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312E\u3131-\u318E\u31A0-\u31BA\u31F0-\u31FF\u3400-\u4DB5\u4E00-\u9FEA\uA000-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6EF\uA717-\uA71F\uA722-\uA788\uA78B-\uA7AE\uA7B0-\uA7B7\uA7F7-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA8FD\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uA9E0-\uA9E4\uA9E6-\uA9EF\uA9FA-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB65\uAB70-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDD40-\uDD74\uDE80-\uDE9C\uDEA0-\uDED0\uDF00-\uDF1F\uDF2D-\uDF4A\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF\uDFD1-\uDFD5]|\uD801[\uDC00-\uDC9D\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD80-\uDDB7\uDDBE\uDDBF\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE33\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE4\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2]|\uD804[\uDC03-\uDC37\uDC83-\uDCAF\uDCD0-\uDCE8\uDD03-\uDD26\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE2B\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE80-\uDEAA\uDF00-\uDF19]|\uD806[\uDCA0-\uDCDF\uDCFF\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE83\uDE86-\uDE89\uDEC0-\uDEF8]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46]|\uD808[\uDC00-\uDF99]|\uD809[\uDC00-\uDC6E\uDC80-\uDD43]|[\uD80C\uD81C-\uD820\uD840-\uD868\uD86A-\uD86C\uD86F-\uD872\uD874-\uD879][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2E]|\uD811[\uDC00-\uDE46]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDF00-\uDF44\uDF50\uDF93-\uDF9F\uDFE0\uDFE1]|\uD821[\uDC00-\uDFEC]|\uD822[\uDC00-\uDEF2]|\uD82C[\uDC00-\uDD1E\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB]|\uD83A[\uDC00-\uDCC4\uDD00-\uDD43]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDED6\uDF00-\uDFFF]|\uD86D[\uDC00-\uDF34\uDF40-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEA1\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0]|\uD87E[\uDC00-\uDE1D]/;Hr.exports.ID_Continue=/[\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0300-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u0483-\u0487\u048A-\u052F\u0531-\u0556\u0559\u0561-\u0587\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u05D0-\u05EA\u05F0-\u05F2\u0610-\u061A\u0620-\u0669\u066E-\u06D3\u06D5-\u06DC\u06DF-\u06E8\u06EA-\u06FC\u06FF\u0710-\u074A\u074D-\u07B1\u07C0-\u07F5\u07FA\u0800-\u082D\u0840-\u085B\u0860-\u086A\u08A0-\u08B4\u08B6-\u08BD\u08D4-\u08E1\u08E3-\u0963\u0966-\u096F\u0971-\u0983\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BC-\u09C4\u09C7\u09C8\u09CB-\u09CE\u09D7\u09DC\u09DD\u09DF-\u09E3\u09E6-\u09F1\u09FC\u0A01-\u0A03\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A3C\u0A3E-\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A59-\u0A5C\u0A5E\u0A66-\u0A75\u0A81-\u0A83\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABC-\u0AC5\u0AC7-\u0AC9\u0ACB-\u0ACD\u0AD0\u0AE0-\u0AE3\u0AE6-\u0AEF\u0AF9-\u0AFF\u0B01-\u0B03\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3C-\u0B44\u0B47\u0B48\u0B4B-\u0B4D\u0B56\u0B57\u0B5C\u0B5D\u0B5F-\u0B63\u0B66-\u0B6F\u0B71\u0B82\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BBE-\u0BC2\u0BC6-\u0BC8\u0BCA-\u0BCD\u0BD0\u0BD7\u0BE6-\u0BEF\u0C00-\u0C03\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D-\u0C44\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C58-\u0C5A\u0C60-\u0C63\u0C66-\u0C6F\u0C80-\u0C83\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBC-\u0CC4\u0CC6-\u0CC8\u0CCA-\u0CCD\u0CD5\u0CD6\u0CDE\u0CE0-\u0CE3\u0CE6-\u0CEF\u0CF1\u0CF2\u0D00-\u0D03\u0D05-\u0D0C\u0D0E-\u0D10\u0D12-\u0D44\u0D46-\u0D48\u0D4A-\u0D4E\u0D54-\u0D57\u0D5F-\u0D63\u0D66-\u0D6F\u0D7A-\u0D7F\u0D82\u0D83\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0DCA\u0DCF-\u0DD4\u0DD6\u0DD8-\u0DDF\u0DE6-\u0DEF\u0DF2\u0DF3\u0E01-\u0E3A\u0E40-\u0E4E\u0E50-\u0E59\u0E81\u0E82\u0E84\u0E87\u0E88\u0E8A\u0E8D\u0E94-\u0E97\u0E99-\u0E9F\u0EA1-\u0EA3\u0EA5\u0EA7\u0EAA\u0EAB\u0EAD-\u0EB9\u0EBB-\u0EBD\u0EC0-\u0EC4\u0EC6\u0EC8-\u0ECD\u0ED0-\u0ED9\u0EDC-\u0EDF\u0F00\u0F18\u0F19\u0F20-\u0F29\u0F35\u0F37\u0F39\u0F3E-\u0F47\u0F49-\u0F6C\u0F71-\u0F84\u0F86-\u0F97\u0F99-\u0FBC\u0FC6\u1000-\u1049\u1050-\u109D\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u135D-\u135F\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16EE-\u16F8\u1700-\u170C\u170E-\u1714\u1720-\u1734\u1740-\u1753\u1760-\u176C\u176E-\u1770\u1772\u1773\u1780-\u17D3\u17D7\u17DC\u17DD\u17E0-\u17E9\u180B-\u180D\u1810-\u1819\u1820-\u1877\u1880-\u18AA\u18B0-\u18F5\u1900-\u191E\u1920-\u192B\u1930-\u193B\u1946-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u19D0-\u19D9\u1A00-\u1A1B\u1A20-\u1A5E\u1A60-\u1A7C\u1A7F-\u1A89\u1A90-\u1A99\u1AA7\u1AB0-\u1ABD\u1B00-\u1B4B\u1B50-\u1B59\u1B6B-\u1B73\u1B80-\u1BF3\u1C00-\u1C37\u1C40-\u1C49\u1C4D-\u1C7D\u1C80-\u1C88\u1CD0-\u1CD2\u1CD4-\u1CF9\u1D00-\u1DF9\u1DFB-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u203F\u2040\u2054\u2071\u207F\u2090-\u209C\u20D0-\u20DC\u20E1\u20E5-\u20F0\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2160-\u2188\u2C00-\u2C2E\u2C30-\u2C5E\u2C60-\u2CE4\u2CEB-\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D7F-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2DE0-\u2DFF\u2E2F\u3005-\u3007\u3021-\u302F\u3031-\u3035\u3038-\u303C\u3041-\u3096\u3099\u309A\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312E\u3131-\u318E\u31A0-\u31BA\u31F0-\u31FF\u3400-\u4DB5\u4E00-\u9FEA\uA000-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA62B\uA640-\uA66F\uA674-\uA67D\uA67F-\uA6F1\uA717-\uA71F\uA722-\uA788\uA78B-\uA7AE\uA7B0-\uA7B7\uA7F7-\uA827\uA840-\uA873\uA880-\uA8C5\uA8D0-\uA8D9\uA8E0-\uA8F7\uA8FB\uA8FD\uA900-\uA92D\uA930-\uA953\uA960-\uA97C\uA980-\uA9C0\uA9CF-\uA9D9\uA9E0-\uA9FE\uAA00-\uAA36\uAA40-\uAA4D\uAA50-\uAA59\uAA60-\uAA76\uAA7A-\uAAC2\uAADB-\uAADD\uAAE0-\uAAEF\uAAF2-\uAAF6\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB65\uAB70-\uABEA\uABEC\uABED\uABF0-\uABF9\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE00-\uFE0F\uFE20-\uFE2F\uFE33\uFE34\uFE4D-\uFE4F\uFE70-\uFE74\uFE76-\uFEFC\uFF10-\uFF19\uFF21-\uFF3A\uFF3F\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDD40-\uDD74\uDDFD\uDE80-\uDE9C\uDEA0-\uDED0\uDEE0\uDF00-\uDF1F\uDF2D-\uDF4A\uDF50-\uDF7A\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF\uDFD1-\uDFD5]|\uD801[\uDC00-\uDC9D\uDCA0-\uDCA9\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD80-\uDDB7\uDDBE\uDDBF\uDE00-\uDE03\uDE05\uDE06\uDE0C-\uDE13\uDE15-\uDE17\uDE19-\uDE33\uDE38-\uDE3A\uDE3F\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE6\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2]|\uD804[\uDC00-\uDC46\uDC66-\uDC6F\uDC7F-\uDCBA\uDCD0-\uDCE8\uDCF0-\uDCF9\uDD00-\uDD34\uDD36-\uDD3F\uDD50-\uDD73\uDD76\uDD80-\uDDC4\uDDCA-\uDDCC\uDDD0-\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE37\uDE3E\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEEA\uDEF0-\uDEF9\uDF00-\uDF03\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3C-\uDF44\uDF47\uDF48\uDF4B-\uDF4D\uDF50\uDF57\uDF5D-\uDF63\uDF66-\uDF6C\uDF70-\uDF74]|\uD805[\uDC00-\uDC4A\uDC50-\uDC59\uDC80-\uDCC5\uDCC7\uDCD0-\uDCD9\uDD80-\uDDB5\uDDB8-\uDDC0\uDDD8-\uDDDD\uDE00-\uDE40\uDE44\uDE50-\uDE59\uDE80-\uDEB7\uDEC0-\uDEC9\uDF00-\uDF19\uDF1D-\uDF2B\uDF30-\uDF39]|\uD806[\uDCA0-\uDCE9\uDCFF\uDE00-\uDE3E\uDE47\uDE50-\uDE83\uDE86-\uDE99\uDEC0-\uDEF8]|\uD807[\uDC00-\uDC08\uDC0A-\uDC36\uDC38-\uDC40\uDC50-\uDC59\uDC72-\uDC8F\uDC92-\uDCA7\uDCA9-\uDCB6\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD36\uDD3A\uDD3C\uDD3D\uDD3F-\uDD47\uDD50-\uDD59]|\uD808[\uDC00-\uDF99]|\uD809[\uDC00-\uDC6E\uDC80-\uDD43]|[\uD80C\uD81C-\uD820\uD840-\uD868\uD86A-\uD86C\uD86F-\uD872\uD874-\uD879][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2E]|\uD811[\uDC00-\uDE46]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE60-\uDE69\uDED0-\uDEED\uDEF0-\uDEF4\uDF00-\uDF36\uDF40-\uDF43\uDF50-\uDF59\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDF00-\uDF44\uDF50-\uDF7E\uDF8F-\uDF9F\uDFE0\uDFE1]|\uD821[\uDC00-\uDFEC]|\uD822[\uDC00-\uDEF2]|\uD82C[\uDC00-\uDD1E\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99\uDC9D\uDC9E]|\uD834[\uDD65-\uDD69\uDD6D-\uDD72\uDD7B-\uDD82\uDD85-\uDD8B\uDDAA-\uDDAD\uDE42-\uDE44]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB\uDFCE-\uDFFF]|\uD836[\uDE00-\uDE36\uDE3B-\uDE6C\uDE75\uDE84\uDE9B-\uDE9F\uDEA1-\uDEAF]|\uD838[\uDC00-\uDC06\uDC08-\uDC18\uDC1B-\uDC21\uDC23\uDC24\uDC26-\uDC2A]|\uD83A[\uDC00-\uDCC4\uDCD0-\uDCD6\uDD00-\uDD4A\uDD50-\uDD59]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDED6\uDF00-\uDFFF]|\uD86D[\uDC00-\uDF34\uDF40-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEA1\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0]|\uD87E[\uDC00-\uDE1D]|\uDB40[\uDD00-\uDDEF]/});var Zn=oe((mx,la)=>{var Xn=ua();la.exports={isSpaceSeparator(e){return typeof e=="string"&&Xn.Space_Separator.test(e)},isIdStartChar(e){return typeof e=="string"&&(e>="a"&&e<="z"||e>="A"&&e<="Z"||e==="$"||e==="_"||Xn.ID_Start.test(e))},isIdContinueChar(e){return typeof e=="string"&&(e>="a"&&e<="z"||e>="A"&&e<="Z"||e>="0"&&e<="9"||e==="$"||e==="_"||e==="\u200C"||e==="\u200D"||Xn.ID_Continue.test(e))},isDigit(e){return typeof e=="string"&&/[0-9]/.test(e)},isHexDigit(e){return typeof e=="string"&&/[0-9A-Fa-f]/.test(e)}}});var fa=oe((dx,da)=>{var re=Zn(),ti,de,it,Qr,gt,ke,ne,ii,Cr;da.exports=function(t,n){ti=String(t),de="start",it=[],Qr=0,gt=1,ke=0,ne=void 0,ii=void 0,Cr=void 0;do ne=Wp(),Hp[de]();while(ne.type!=="eof");return typeof n=="function"?ri({"":Cr},"",n):Cr};function ri(e,t,n){let r=e[t];if(r!=null&&typeof r=="object")if(Array.isArray(r))for(let o=0;o<r.length;o++){let s=String(o),i=ri(r,s,n);i===void 0?delete r[s]:Object.defineProperty(r,s,{value:i,writable:!0,enumerable:!0,configurable:!0})}else for(let o in r){let s=ri(r,o,n);s===void 0?delete r[o]:Object.defineProperty(r,o,{value:s,writable:!0,enumerable:!0,configurable:!0})}return n.call(e,t,r)}var R,P,hr,nt,k;function Wp(){for(R="default",P="",hr=!1,nt=1;;){k=ot();let e=pa[R]();if(e)return e}}function ot(){if(ti[Qr])return String.fromCodePoint(ti.codePointAt(Qr))}function x(){let e=ot();return e===`
...
`)),this._prevFrame=t;return}this.output.write(Fe.erase.down())}this.output.write(t),this.state==="initial"&&(this.state="active"),this._prevFrame=t}}},Mr=class extends In{get cursor(){return this.value?0:1}get _value(){return this.cursor===0}constructor(t){super(t,!1),this.value=!!t.initialValue,this.on("value",()=>{this.value=this._value}),this.on("confirm",n=>{this.output.write(Fe.cursor.move(0,-1)),this.value=n,this.state="submit",this.close()}),this.on("cursor",()=>{this.value=!this.value})}};var El;El=new WeakMap;var ve=T(require("process"),1),$=T(et(),1),Ko=T(Nr(),1);function Fl(){return ve.default.platform!=="win32"?ve.default.env.TERM!=="linux":!!ve.default.env.CI||!!ve.default.env.WT_SESSION||!!ve.default.env.TERMINUS_SUBLIME||ve.default.env.ConEmuTask==="{cmd::Cmder}"||ve.default.env.TERM_PROGRAM==="Terminus-Sublime"||ve.default.env.TERM_PROGRAM==="vscode"||ve.default.env.TERM==="xterm-256color"||ve.default.env.TERM==="alacritty"||ve.default.env.TERMINAL_EMULATOR==="JetBrains-JediTerm"}var wl=Fl(),Q=(e,t)=>wl?e:t,bl=Q("\u25C6","*"),Sl=Q("\u25A0","x"),vl=Q("\u25B2","x"),zo=Q("\u25C7","o"),Al=Q("\u250C","T"),Oe=Q("\u2502","|"),Go=Q("\u2514","\u2014"),Uo=Q("\u25CF",">"),Vo=Q("\u25CB"," "),Rf=Q("\u25FB","[\u2022]"),Bf=Q("\u25FC","[+]"),kf=Q("\u25FB","[ ]"),Nf=Q("\u25AA","\u2022"),$f=Q("\u2500","-"),Lf=Q("\u256E","+"),Of=Q("\u251C","+"),_f=Q("\u256F","+"),Pl=Q("\u25CF","\u2022"),Tl=Q("\u25C6","*"),Il=Q("\u25B2","!"),Rl=Q("\u25A0","x"),Bl=e=>{switch(e){case"initial":case"active":return $.default.cyan(bl);case"cancel":return $.default.red(Sl);case"error":return $.default.yellow(vl);case"submit":return $.default.green(zo)}};var or=e=>{let t=e.active??"Yes",n=e.inactive??"No";return new Mr({active:t,inactive:n,initialValue:e.initialValue??!0,render(){let r=`${$.default.gray(Oe)}
${Bl(this.state)}  ${e.message}
`,o=this.value?t:n;switch(this.state){case"submit":return`${r}${$.default.gray(Oe)}  ${$.default.dim(o)}`;case"cancel":return`${r}${$.default.gray(Oe)}  ${$.default.strikethrough($.default.dim(o))}
${$.default.gray(Oe)}`;default:return`${r}${$.default.cyan(Oe)}  ${this.value?`${$.default.green(Uo)} ${t}`:`${$.default.dim(Vo)} ${$.default.dim(t)}`} ${$.default.dim("/")} ${this.value?`${$.default.dim(Vo)} ${$.default.dim(n)}`:`${$.default.green(Uo)} ${n}`}
${$.default.cyan(Go)}
`}}}).prompt()};var tt=(e="")=>{process.stdout.write(`${$.default.gray(Al)}  ${e}
`)},sr=(e="")=>{process.stdout.write(`${$.default.gray(Oe)}
${$.default.gray(Go)}  ${e}

`)},j={message:(e="",{symbol:t=$.default.gray(Oe)}={})=>{let n=[`${$.default.gray(Oe)}`];if(e){let[r,...o]=e.split(`
`);n.push(`${t}  ${r}`,...o.map(s=>`${$.default.gray(Oe)}  ${s}`))}process.stdout.write(`${n.join(`
`)}
`)},info:e=>{j.message(e,{symbol:$.default.blue(Pl)})},success:e=>{j.message(e,{symbol:$.default.green(Tl)})},step:e=>{j.message(e,{symbol:$.default.green(zo)})},warn:e=>{j.message(e,{symbol:$.default.yellow(Il)})},warning:e=>{j.warn(e)},error:e=>{j.message(e,{symbol:$.default.red(Rl)})}},Mf=`${$.default.gray(Oe)}  `;var yt=T(et(),1);var O=T(require("typescript"),1);async function _e(e){let t=Wo(e),n=await e.readFile(t);return typeof n=="string"?JSON.parse(n):{}}async function Me(e,t){t=typeof t=="object"&&t!=null?t:{};let n=Wo(e);await e.writeFile(n,JSON.stringify(t??{},null,2))}function Wo(e){let t=e.getAppRootDir();return e.join(t,"node_modules",".builder","builder-cache.json")}async function pt(e,t,n){let r={envKey:n,envValue:null,file:""};for(let o of t){let s=e.join(e.getAppRootDir(),o),i=await kl(e,s);if(i){let a=i[n];if(typeof a=="string"&&a.length>0&&a!=="YOUR_API_KEY")return r.envValue=a,r.file=s,r}}return r.file=e.join(e.getAppRootDir(),t[t.length-1]),r}async function kl(e,t){let n=await e.readFile(t);return typeof n=="string"?qo(n):null}function qo(e){let t={},n=e.replace(/\r\n?/gm,`
`),r;for(;(r=Nl.exec(n))!=null;){let o=r[1],s=r[2]||"";s=s.trim();let i=s[0];s=s.replace(/^(['"`])([\s\S]*)\1$/gm,"$2"),i==='"'&&(s=s.replace(/\\n/g,`
`),s=s.replace(/\\r/g,"\r")),t[o]=s}return t}var Nl=/(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/gm;async function mt(e,t,n,r){let o="# https://www.builder.io/c/docs/using-your-api-key",s=await e.readFile(t);try{if(s)if(s.includes(n))if(s.includes(r))e.debug(`"${n}" with "${r}" already set in ${t}`);else return e.debug(`Replace "${n}" in ${t}`),s=s.replace(new RegExp(`${n}=.*`),`${n}=${r}`),await e.writeFile(t,s),"update";else return e.debug(`Append "${n}" to ${t}`),s+=`

${o}
${n}=${r}

`,await e.writeFile(t,s),"update";else return e.debug(`Creating new .env file with "${n}" at ${t}`),s=[o,`${n}=${r}`,""].join(`
`),await e.writeFile(t,s),"create"}catch(i){if(i&&String(i).includes("EACCES"))return e.debug(`Permssion denied, failed to create or modify .env file with "${n}=${r}" at ${t}`),"permission-error";e.Sentry?.captureException(i)}return null}async function ar(e){return await pt(e,[".env.local",".env.development.local",".env.production.local",".env.development",".env.production",".env"],je)}async function Jo(e,t){let n=await ar(e),r=await mt(e,n.file,n.envKey,t);return{...n,modifiedType:r}}var je="NEXT_PUBLIC_BUILDER_API_KEY";function Mt(e,t,n,r,o=!0){let s=t.properties.filter(a=>e.ts.isPropertyAssignment(a)),i=$l(e,t,n);return i>-1?r==null&&o?e.ts.factory.updateObjectLiteralExpression(t,s.filter((a,u)=>u!==i)):(s[i]=e.ts.factory.updatePropertyAssignment(s[i],s[i].name,ur(e,r)),e.ts.factory.updateObjectLiteralExpression(t,s)):(r!=null&&s.push(e.ts.factory.createPropertyAssignment(n,ur(e,r))),e.ts.factory.updateObjectLiteralExpression(t,s))}function $l(e,t,n){return t.properties.findIndex(r=>K(e,r)===n)}function lr(e,t){switch(t.kind){case e.ts.SyntaxKind.ArrayLiteralExpression:return Ol(e,t);case e.ts.SyntaxKind.ObjectLiteralExpression:return Ll(e,t);case e.ts.SyntaxKind.StringLiteral:return t.text;case e.ts.SyntaxKind.NumericLiteral:return Number(t.text);case e.ts.SyntaxKind.NoSubstitutionTemplateLiteral:return t.text;case e.ts.SyntaxKind.TrueKeyword:return!0;case e.ts.SyntaxKind.FalseKeyword:return!1;case e.ts.SyntaxKind.Identifier:switch(t.escapedText){case"undefined":return;case"null":return null;case"String":return String;case"Number":return Number;case"Boolean":return Boolean;case"NaN":return NaN}}}function Ll(e,t){let n={};if(t&&e.ts.isObjectLiteralExpression(t)){for(let r of t.properties)if(e.ts.isPropertyAssignment(r)){let o=K(e,r);o&&(n[o]=lr(e,r.initializer))}}return n}function Ol(e,t){return t&&e.ts.isArrayLiteralExpression(t)?t.elements.map(n=>lr(e,n)):[]}function K(e,t){if(t&&e.ts.isPropertyAssignment(t)){let n=t.name;switch(n.kind){case e.ts.SyntaxKind.Identifier:return n.text;case e.ts.SyntaxKind.StringLiteral:case e.ts.SyntaxKind.NumericLiteral:return n.text;case e.ts.SyntaxKind.ComputedPropertyName:let r=n.expression;if(e.ts.isStringLiteral(r)||e.ts.isNumericLiteral(r))return n.expression.text}}}function ur(e,t){return kn(e,t,new WeakSet)}function kn(e,t,n){return t===void 0?e.ts.factory.createIdentifier("undefined"):t===null?e.ts.factory.createIdentifier("null"):typeof t=="string"?e.ts.factory.createStringLiteral(t):typeof t=="number"?isNaN(t)?e.ts.factory.createIdentifier("NaN"):e.ts.factory.createNumericLiteral(t):t===!0?e.ts.factory.createTrue():t===!1?e.ts.factory.createFalse():t===String?e.ts.factory.createIdentifier("String"):t===Number?e.ts.factory.createIdentifier("Number"):t===Boolean?e.ts.factory.createIdentifier("Boolean"):Array.isArray(t)?_l(e,t,n):typeof t=="object"?Ml(e,t,n):e.ts.factory.createIdentifier(t)}function _l(e,t,n){let r=t.map(o=>kn(e,o,n));return e.ts.factory.createArrayLiteralExpression(r,!0)}function Ml(e,t,n){if(n.has(t))return e.ts.factory.createIdentifier("undefined");n.add(t);let r=Object.keys(t).map(o=>e.ts.factory.createPropertyAssignment(o,kn(e,t[o],n)));return e.ts.factory.createObjectLiteralExpression(r,!0)}function St(e,t,n){let r=[];if(!n)return r;let o=null;if(e.ts.isArrowFunction(n)||e.ts.isFunctionExpression(n)||e.ts.isFunctionDeclaration(n)){let s=n.parameters;if(s.length>0){let i=s[0],a=t.getTypeAtLocation(i);a.aliasTypeArguments&&a.aliasTypeArguments.length>0&&(a=a.aliasTypeArguments[0]),!!(a.flags&e.ts.TypeFlags.Object)&&(o=a.getProperties())}}else if(e.ts.isIdentifier(n)){let s=t.getTypeAtLocation(n),i=s.symbol?.valueDeclaration;if(i&&e.ts.isClassDeclaration(i)){let u=i.heritageClauses?.find(l=>l.token===e.ts.SyntaxKind.ExtendsKeyword)?.types;if(u){for(let l of u)if(t.getSymbolAtLocation(l.expression)?.name==="Component"){if(e.ts.isExpressionWithTypeArguments(l)){let p=l.typeArguments;if(p){let m=p[0];o=t.getTypeFromTypeNode(m).getProperties()}}break}}}if(!o){let a=s.getCallSignatures();if(a.length>0){let u=a[0].getParameters();u.length>0&&(o=t.getTypeOfSymbolAtLocation(u[0],n).getProperties())}}}else if(e.ts.isExportSpecifier(n)){let s=t.getSymbolAtLocation(n.name);if(s){let a=t.getTypeOfSymbolAtLocation(s,n).getCallSignatures();if(a.length>0){let u=a[0].getParameters();u.length>0&&(o=t.getTypeOfSymbolAtLocation(u[0],n).getProperties())}}}if(o)for(let s of o){let i=jl(e,t,s);i&&r.push(i)}return r=r.filter(Yo),r.length>0?r:Ul(e,n)}function jl(e,t,n){let r=n.valueDeclaration,o=n.getName();if(r||(r=n.getDeclarations()?.[0]),r&&e.ts.isPropertySignature(r)){if(o!=="children"&&r.getSourceFile().fileName.includes("node_modules/@types/"))return null;let s="string",i;if(r?.type){let u=t.getTypeFromTypeNode(r.type),l=t.typeToString(u),c=Nn(l);c.knownType?s=c.builderType:Kl(l)||u.flags&e.ts.TypeFlags.StringLike?s="string":u.flags&e.ts.TypeFlags.NumberLike?s="number":u.flags&e.ts.TypeFlags.IndexedAccess?s="list":u.flags&e.ts.TypeFlags.Object||u.isUnion()&&u.types.every(p=>p.flags&e.ts.TypeFlags.Object)||u.isIntersection()&&u.types.some(p=>p.flags&e.ts.TypeFlags.Object)?s="object":s="string",l!==s&&(i=l)}let a={name:o,type:s,isRegistered:!1};if(i&&r.type){let u=ql(e,t,t.getTypeFromTypeNode(r.type));a.meta=a.meta||{},u&&u.length>0&&a.type==="string"&&u.every(Gl)?a.enum=u.map(Wl):a.meta.ts=i}return r.questionToken||(a.required=!0),a}return null}function Ul(e,t){let n=[],r=e.ts.getJSDocCommentsAndTags(t);for(let o of r)if(!(!e.ts.isJSDoc(o)||!o.tags))for(let s of o.tags){if(!e.ts.isJSDocParameterTag(s)||s.tagName.text!=="param")continue;let a=s.typeExpression?.type;if(!a||!e.ts.isJSDocTypeLiteral(a))continue;let u=a.jsDocPropertyTags;if(u)for(let l of u){if(!e.ts.isJSDocPropertyLikeTag(l))continue;let c=l.name;if(!e.ts.isQualifiedName(c))continue;let p=l.typeExpression;if(!p)continue;let m="";switch(p.type.kind){case e.ts.SyntaxKind.StringKeyword:{m="string";break}case e.ts.SyntaxKind.NumberKeyword:{m="number";break}case e.ts.SyntaxKind.BooleanKeyword:{m="boolean";break}default:continue}let g={name:c.right.text,type:m,isRegistered:!1};n.push(g)}}return n.filter(Yo)}var Vl=["ClassicComponent","FunctionComponent","IntrinsicElements","JSX","ReactNode","ReactElement","ReactPortal"];function Kl(e){return typeof e!="string"?!1:!!Vl.some(t=>e.includes(t))}function Nn(e){return typeof e=="string"&&(e=e.trim(),zl.some(t=>t.value===e))?{builderType:e,knownType:!0}:{builderType:"string",knownType:!1}}var zl=[{value:"boolean",text:"boolean"},{value:"color",text:"color (provides a color in hex or rgb)"},{value:"date",text:"date (same format as the Date constructor)"},{value:"email",text:"email"},{value:"file",text:"file (uploads a file and provides a url)"},{value:"list",text:"list (collection of items)"},{value:"longText",text:"longText (multiline text editor)"},{value:"number",text:"number"},{value:"object",text:"object (set of specific names and values)"},{value:"richText",text:"richText (provides value as html)"},{value:"string",text:"string"}];function Gl(e){return/^['"].*['"]$/.test(e)}function Wl(e){return(e.startsWith('"')||e.startsWith("'"))&&(e.endsWith('"')||e.endsWith("'"))?e.slice(1,-1):e}var ql=(e,t,n)=>{let r=new Set;Ho(e,t,n,r);let o=r.delete("true"),s=r.delete("false");(o||s)&&r.add("boolean");let i=Array.from(r.keys()).sort();if(i.length>1&&(i=i.map(a=>a.indexOf("=>")>=0?`(${a})`:a)),!(i.length>20))return i},Jl=(e,t,n)=>{let r=e.ts.TypeFormatFlags.InElementType|e.ts.TypeFormatFlags.NoTruncation;return t.typeToString(n,void 0,r)},Ho=(e,t,n,r)=>{if(n.isUnion())n.types.forEach(o=>{Ho(e,t,o,r)});else if(n.isLiteral()){let o=Jl(e,t,n);r.add(o)}};function Yo(e){let t=e?.name;if(typeof t!="string"||t===""||t.startsWith("aria")||t.startsWith("data-"))return!1;if(t.startsWith("on")&&t.length>2){let n=t.charAt(2);if(n.toUpperCase()===n)return!1}return!Hl.has(t.toLowerCase())}var Hl=new Set(["about","accessKey","accessKeyLabel","asChild","autoCapitalize","autoCorrect","autoFocus","autoSave","blur","contentEditable","contextMenu","dangerouslySetInnerHTML","datatype","defaultChecked","defaultValue","dir","draggable","enterKeyHint","focus","form","formAction","formEncType","formMethod","formNoValidate","formTarget","inlist","innerText","inputMode","is","isContentEditable","itemID","itemProp","itemRef","itemScope","itemType","lang","nonce","offsetHeight","offsetLeft","offsetTop","offsetWidth","outerText","prefix","property","radioGroup","rel","resource","results","rev","role","security","slot","spellCheck","suppressContentEditableWarning","suppressHydrationWarning","tabIndex","translate","typeof","unselectable","vocab"].map(e=>e.toLowerCase()));function ge(e,t,n){for(let r of n.properties){if(!e.ts.isPropertyAssignment(r))continue;let o=K(e,r);if(o==="name"&&e.ts.isStringLiteral(r.initializer)){t.name=r.initializer.text;continue}if(o==="description"&&e.ts.isStringLiteral(r.initializer)){t.description=r.initializer.text;continue}if(o==="image"&&e.ts.isStringLiteral(r.initializer)){t.image=r.initializer.text;continue}if(o==="inputs"&&e.ts.isArrayLiteralExpression(r.initializer)){let s=Yl(e,r.initializer);we(t,s);continue}if(o==="meta"&&e.ts.isObjectLiteralExpression(r.initializer)){let s=lr(e,r.initializer);s&&typeof s=="object"&&(t.meta=s);continue}}return t}function Yl(e,t){let n=[];for(let r of t.elements)e.ts.isObjectLiteralExpression(r)&&n.push(Ql(e,r));return n}function Ql(e,t){let n=lr(e,t),r=ic(n);return r.isRegistered=!0,r}function ee(e,t,n){let r=Zl(n);return t=Mt(e,t,"name",r.name,!1),t=Mt(e,t,"description",r.description),t=Mt(e,t,"image",r.image),t=Mt(e,t,"meta",r.meta),t=Xl(e,t,r),oc(e,t)}function Xl(e,t,n){let r=null,o=t.properties.filter(a=>e.ts.isPropertyAssignment(a)&&e.ts.isIdentifier(a.name)),s=o.findIndex(a=>e.ts.isIdentifier(a.name)&&a.name.text==="inputs"),i=[...n.inputs??[]];if(s>-1){if(i.length===0)return Mt(e,t,"inputs",null);let a=o[s];e.ts.isPropertyAssignment(a)&&e.ts.isArrayLiteralExpression(a.initializer)&&(r=a.initializer)}return i.length===0?t:(r=tc(e,r||e.ts.factory.createArrayLiteralExpression(),i),s>-1?o[s]=e.ts.factory.updatePropertyAssignment(o[s],o[s].name,r):o.push(e.ts.factory.createPropertyAssignment("inputs",r)),e.ts.factory.updateObjectLiteralExpression(t,o))}function Zl(e){return{name:e.name,description:e.description,image:e.image,inputs:(e.inputs||[]).filter(n=>n.isRegistered).map(ec),...e.meta?{meta:{...e.meta}}:{}}}function ec(e){let t={name:e.name,type:e.type};return(me(e.defaultValue)||Zt(e.defaultValue)||Bt(e.defaultValue))&&(t.defaultValue=e.defaultValue),me(e.friendlyName)&&(t.friendlyName=e.friendlyName),me(e.helperText)&&(t.helperText=e.helperText),e.required===!0&&(t.required=!0),Array.isArray(e.enum)&&(t.enum=e.enum),e.hideFromUI===!0&&(t.hideFromUI=!0),typeof e.meta=="object"&&e.meta!=null&&Object.keys(e.meta).length>0&&(t.meta=e.meta),t}function tc(e,t,n){let r=t.elements.filter(o=>{if(!e.ts.isObjectLiteralExpression(o))return!1;let s=o.properties.find(a=>K(e,a)==="name");if(!s)return!1;let i=s.initializer;return e.ts.isStringLiteral(i)?n.some(a=>a.name===i.text):!1});for(let o of n)r=rc(e,r,o);return r.sort((o,s)=>{let i=o.properties.find(m=>K(e,m)==="name"),a=s.properties.find(m=>K(e,m)==="name"),u=i?.initializer,l=a?.initializer,c=u&&e.ts.isStringLiteral(u)?u.text:"zz",p=l&&e.ts.isStringLiteral(l)?l.text:"zz";return c.toLowerCase().localeCompare(p.toLowerCase())}),e.ts.factory.updateArrayLiteralExpression(t,r)}function rc(e,t,n){let r=t.findIndex(o=>o.properties.some(s=>{let i=K(e,s);return e.ts.isPropertyAssignment(s)&&i==="name"&&e.ts.isStringLiteral(s.initializer)&&s.initializer.text===n.name}));if(r>-1)t[r]=Qo(e,t[r],n);else{let o=Qo(e,e.ts.factory.createObjectLiteralExpression([e.ts.factory.createPropertyAssignment("name",e.ts.factory.createStringLiteral(n.name))],!0),n);t.push(o)}return t}function Qo(e,t,n){let r=t.properties.filter(s=>e.ts.isPropertyAssignment(s)),o=Object.keys(n).filter(s=>s!=="isRegistered");for(let s of o)r=nc(e,r,n,s);return r=sc(e,r.filter(s=>{let i=K(e,s);return o.includes(i)})),e.ts.factory.updateObjectLiteralExpression(t,r)}function nc(e,t,n,r){let o=t.findIndex(s=>e.ts.isIdentifier(s.name)&&s.name.text===r);return o>-1?t[o]=e.ts.factory.updatePropertyAssignment(t[o],t[o].name,ur(e,n[r])):t.push(e.ts.factory.createPropertyAssignment(r,ur(e,n[r]))),t}function we(e,t){for(let n of t){let r=e.inputs.findIndex(o=>o.name===n.name);r>-1?(n.isRegistered||!e.inputs[r].isRegistered)&&(e.inputs[r]=n):e.inputs.push(n)}e.acceptsChildren=$n(e)}function ic(e){let t=Nn(e.type),n={name:e.name.trim(),type:t.builderType};return me(e.friendlyName)&&e.friendlyName.trim()!==e.name.trim()&&(n.friendlyName=e.friendlyName),(me(e.defaultValue)||Zt(e.defaultValue)||Bt(e.defaultValue))&&(n.defaultValue=e.defaultValue),me(e.helperText)&&(n.helperText=e.helperText),Bt(e.required)&&(n.required=e.required),typeof e.meta=="object"&&e.meta!=null&&Object.keys(e.meta).length>0&&(n.meta=e.meta),Array.isArray(e.enum)&&e.enum.length>0&&(n.enum=e.enum),e.hideFromUI===!0&&(n.hideFromUI=!0),Ln(n)}function $n(e){let t=e.inputs.some(r=>r.name==="children"),n=e.inputs.some(r=>r.meta?.ts==="ReactNode");return!!(t||n||e.acceptsChildren===!0)}function Ln(e){if(e.name==="children"&&(e.hideFromUI=!0,delete e.required),e.type==="object"&&e.defaultValue==null&&(e.hideFromUI=!0),e.type==="list"&&e.defaultValue==null&&(e.hideFromUI=!0),e.meta){let t=e.meta.ts;typeof t=="string"&&(t=t.trim(),t.endsWith("ReactNode")&&(t="ReactNode"),e.meta.ts=t,t==="ReactNode"&&(e.hideFromUI=!0))}return e}function oc(e,t){let n=[...t.properties].sort((r,o)=>{let s=K(e,r)||"zz",i=K(e,o)||"zz";if(s==="inputs")return 1;let a=Xo.indexOf(s),u=Xo.indexOf(i);return a>-1?u>-1&&a>u?1:-1:u>-1?a>-1&&u<a?-1:1:s.localeCompare(i)});return e.ts.factory.updateObjectLiteralExpression(t,n)}var Xo=["component","name","description"];function sc(e,t){return[...t].sort((r,o)=>{let s=K(e,r)||"zz",i=K(e,o)||"zz",a=Zo.indexOf(s),u=Zo.indexOf(i);return a>-1?u>-1&&a>u?1:-1:u>-1?a>-1&&u<a?-1:1:s.localeCompare(i)})}var Zo=["name","type"];function jt(e,t){for(let n of t.properties){if(!e.ts.isPropertyAssignment(n)||!e.ts.isIdentifier(n.name))continue;if(K(e,n)==="canHaveChildren"){let{initializer:o}=n;return o.kind===e.ts.SyntaxKind.TrueKeyword}}return!1}function es(e,t){let n=`Builder.registerComponent(
...
interface BuilderPageProps {
  ...
  const builderApiKey = process.env.${je}${t?"!":""};
...
// Builder Public API Key set in .env file
const PUBLIC_API_KEY = process.env.${je}${r?"!":""};
...
const BUILDER_API_KEY = process.env.${je}${r?"!":""};
...
`.trimStart();return{component:n,styles:r}}async function bs(e,t,n){if(!await e.exists(e.registryPath)){if(e.sdkVersion===A.gen2){let s=jc(e);await e.writeFile(e.registryPath,s)}else await e.writeFile(e.registryPath,"");t.push({filePath:e.registryPath,modifiedType:"create"})}if(!n)return;let o=(await Je(e,null,!1,!1,null,null,!1,!1)).components.find(s=>s.filePath===n);o&&await Je(e,o.id,!0,!1,null,null,!0,!1)}function jc(e){return e.typescriptEnabled?`import type { RegisteredComponent } from "@builder.io/sdk-react";

export const CUSTOM_COMPONENTS: RegisteredComponent[] = [
];`:`export const CUSTOM_COMPONENTS = [
  ];
  `}async function Wt(e){let t=await ct(e,e.getRepoRootDir());if(t&&typeof t=="object"){let n=new Set(Object.keys({...t.dependencies,...t.devDependencies}));if(n.has("@builder.io/sdk-react"))return A.gen2;if(n.has("@builder.io/react"))return A.gen1}return null}async function Ss(e){let t=await Uc(e);return{builderPageOptions:async()=>({templateContentId:"3de2f13211234071a4b19a17b4fbc5a7",pathname:"/builder-demo",title:"Builder + Next.js Demo Page"}),ensureBuilderSetup:()=>xs(t),ensureFigmaImportPage:()=>ys(t),getRegistryPath:()=>t.registryPath,getRegistry:r=>Je(t,null,!1,!1,null,null,!1,!!r?.readAllInputTypes),addExternalPackage:r=>{t.addExternalPackage(r)},loadComponent:async r=>{let o=await Je(t,r.cmpId,!1,!1,null,null,!1,!1);return{...o,component:o.components.find(s=>s.id===r.cmpId)}},registerComponent:r=>Je(t,r.cmpId,!0,!1,null,null,!0,!1),setRegisteredComponentInfo:r=>Je(t,r.cmpId,!1,!1,r,null,!0,!1),setRegisteredComponentInput:r=>Je(t,r.cmpId,!1,!1,null,r,!0,!1),unregisterComponent:r=>Je(t,r.cmpId,!1,!0,null,null,!0,!1),getPublicApiKey:()=>ar(t),setPublicApiKey:r=>Jo(t,r.publicApiKey),getDependencies:r=>r.sdkVersion===A.gen2?[{name:"@builder.io/dev-tools"},{name:"@builder.io/sdk-react"}]:[{name:"@builder.io/dev-tools"},{name:"@builder.io/react"},{name:"@builder.io/sdk"}],getDevRunCommand:()=>"dev",getCache:()=>_e(t),setCache:r=>Me(t,r)}}async function Uc(e){let t=e.getAppRootDir(),n=e.join(t,"src"),r=await Vc(e),o=await ye(e),s=e.getFrameworks().find(l=>l.name==="next"),i={asyncParams:s?.version?.major!==void 0&&s.version.major>=15},a={},u={...e,addExternalPackage:l=>{a[e.join(t,l,"index.ts")]=`export * from "${l}";`},readFileSync:l=>a[l]??e.readFileSync(l),existsSync:l=>!!a[l]||e.existsSync(l),readdirSync:l=>{let c=e.readdirSync(l);return l===t?[...c,...Object.keys(a).map(p=>p.slice(t.length+1))]:c},readdir:async l=>{let c=await e.readdir(l);return l===t?[...c,...Object.keys(a).map(p=>p.slice(t.length+1))]:c},appDir:null,pagesDir:null,srcDir:null,builderComponentPath:"",componentsDir:"",registryPath:"",nextConfigPath:r,typescriptEnabled:o,features:i};if(e.sdkVersion?u.sdkVersion=e.sdkVersion:u.sdkVersion=await Wt(u),await e.exists(n)){u.srcDir=n,u.componentsDir=e.join(n,"components");let l=e.join(n,"app");await e.exists(l)&&(u.appDir=l);let c=e.join(n,"pages");await e.exists(c)&&(u.pagesDir=c),u.registryPath=await Se(e,n)}else u.componentsDir=e.join(t,"components"),u.registryPath=await Se(e,t);if(u.builderComponentPath=e.join(u.componentsDir,`builder.${o?"tsx":"jsx"}`),!u.appDir){let l=e.join(t,"app");await e.exists(l)&&(u.appDir=l)}if(!u.pagesDir){let l=e.join(t,"pages");await e.exists(l)&&(u.pagesDir=l)}if(!u.appDir&&!u.pagesDir&&!e.ignoreMissingConfig)throw new Error(`Could not find Next.js "app" or "pages" directory. Searched in "${t}".`);return u}async function Vc(e){let t=e.join(e.getAppRootDir(),"next.config.ts");if(await e.exists(t))return t;let n=e.join(e.getAppRootDir(),"next.config.mjs");if(await e.exists(n))return n;let r=e.join(e.getAppRootDir(),"next.config.js");if(await e.exists(r))return r;throw new Error(`Could not find Next.js config file. Searched for "next.config.ts", "next.config.mjs" and "next.config.js" in "${e.getAppRootDir()}".`)}async function pr(e){return await pt(e,[".env"],As)}async function vs(e,t){Kc(t);let n=await pr(e),r=await mt(e,n.file,n.envKey,t);return{...n,modifiedType:r}}function Kc(e){typeof process<"u"&&(process.env[As]=e)}var As="PUBLIC_BUILDER_API_KEY";function Ps(e,t,n){if(n.length===0)return e;let r=e.split(`
`),o=r.findIndex(a=>a.includes(n));if(o===-1||r.some(a=>a.includes(t[0])))return e;let i=["/**",...t.map(a=>` * ${a.trim()}`)," */"];return r.splice(o,0,...i),r.join(`
`)}async function Is(e,t){let n=[],r=t.getSourceFiles(),o=t.getTypeChecker();return await Promise.all(r.map(async s=>{let i=e.basename(s.fileName);if(i.startsWith(".")||Wc.has(i))return;let a=e.normalize(s.fileName);if(a===e.registryPath)return;let u=await Kr(e,o,a,s);n.push(...u)})),n}async function Rs(e,t){if(e.extname(t).toLowerCase()===".tsx"){let r=await e.readFile(t);if(r)return zc(e,t,r)}return null}function zc(e,t,n){let r=N(e,n);return Kr(e,null,t,r)}async function Kr(e,t,n,r){n=e.normalize(n);let o=[],s=vt(e,r);return await Promise.all(s.map(async i=>{let a=await Gc(e,t,n,i);a&&o.push(a)})),o}async function Gc(e,t,n,r){let o=e.relative(e.getAppRootDir(),n),s=W(e,n);if(e.ts.isVariableStatement(r.node))for(let i of r.node.declarationList.declarations){let a=Ts(e,i.initializer);if(a&&e.ts.isIdentifier(i.name)){let u=i.name.text;return{cmpInfo:{id:await z(e,n,u),displayFilePath:M(e,n),name:G(u),inputs:[],exportName:r.isDefaultExport?"default":u,exportType:r.isDefaultExport?"default":"named",importName:u,filePath:n,relFilePath:o,importPath:s,framework:"qwik"},node:a}}}else if(e.ts.isCallExpression(r.node)){let i=Ts(e,r.node);if(i)return{cmpInfo:{id:await z(e,n,"default"),displayFilePath:M(e,n),name:be(e,n),inputs:[],exportName:"default",exportType:"default",importName:bt(e,n),filePath:n,relFilePath:o,importPath:s,framework:"qwik"},node:i}}return null}function Ts(e,t){if(t&&e.ts.isCallExpression(t)&&e.ts.isIdentifier(t.expression)&&t.expression.text==="component$"&&t.arguments.length>0){let n=t.arguments[0];if(e.ts.isArrowFunction(n)||e.ts.isFunctionExpression(n))return{callExpression:t,fnNode:n}}return null}var Wc=new Set(["node_modules","layout.tsx","404.tsx","router-head.tsx"]);async function Bs(e,t){let n=t.node.fnNode;if((e.ts.isArrowFunction(n)||e.ts.isFunctionExpression(n))&&n.parameters.length>0){let{sourceFile:o,typeChecker:s}=await Nt(e,t.cmpInfo.filePath,null);if(!(await Kr(e,s,t.cmpInfo.filePath,o)).find(u=>u.cmpInfo.id===t.cmpInfo.id))throw new Error(`createComponentInputs() Could not find component ${t.cmpInfo.name} in ${t.cmpInfo.filePath}`);return St(e,s,n)}return[]}async function ks(e){return zn(e)}async function zn(e){let t=[];return await e.exists(e.registryPath)||(await e.writeFile(e.registryPath,qc),t.push({filePath:e.registryPath,modifiedType:"create"})),t}var qc=`import type { RegisteredComponent } from "@builder.io/sdk-qwik";

export const CUSTOM_COMPONENTS: RegisteredComponent[] = [
];
`;async function Ns(e){await zn(e);let t=await e.readFile(e.registryPath);return t?Jc(e,t):{components:[],sourceFile:N(e,"")}}async function Jc(e,t){let n=N(e,t);return Hc(e,n)}async function Hc(e,t){let n=[],r=X(e,t,"CUSTOM_COMPONENTS");return r&&await Promise.all(r.arrayLiteralExp.elements.map(async(o,s)=>{let i=await Gn(e,t,o);i&&(i.nodeIndex=s,n.push(i))})),{sourceFile:t,components:fe(n)}}async function Gn(e,t,n){if(!e.ts.isObjectLiteralExpression(n))return null;let r={id:"",name:"",displayFilePath:"",exportName:"",importName:"",filePath:"",relFilePath:"",importPath:"",inputs:[],framework:"qwik"};for(let o of n.properties){if(!e.ts.isPropertyAssignment(o)||!e.ts.isIdentifier(o.name))continue;if(K(e,o)==="component"&&e.ts.isIdentifier(o.initializer)){let i=o.initializer.text;r.name===""&&(r.name=G(i)),r.importName=i;let a=await Ue(e,e.registryPath,t,i);if(!a)continue;r.filePath=a.filePath,r.relFilePath=a.relFilePath,r.importPath=W(e,a.filePath),r.displayFilePath=a.displayFilePath,r.exportType=a.exportType;let u=await Rs(e,a.filePath);if(u&&u.length>0)if(u.length===1)r.exportName=u[0].cmpInfo.exportName;else{let l=u.find(c=>c.cmpInfo.exportName===i);l&&(r.exportName=l.cmpInfo.exportName)}continue}}return r=ge(e,r,n),r.filePath&&r.exportName&&(r.id=await z(e,r.filePath,r.exportName)),r}async function $s(e){let t=new Set,n=async o=>{let s=await e.readdir(o);await Promise.all(s.map(async i=>{if(i.startsWith(".")||i==="node_modules")return;let a=e.join(o,i),u=e.extname(i).toLowerCase();if(u===".tsx"||u===".ts"){t.add(a);return}(await e.stat(a)).isDirectory()&&await n(a)}))};return await n(e.getAppRootDir()),await Z(e,[...t])}async function At(e,t,n,r,o,s,i,a){let u=await $s(e),[l,c,p]=await Promise.all([Is(e,u),Ns(e),pr(e)]),m=l.map(f=>f.cmpInfo),D=c.components,g={components:Be(m,D),registryPath:e.registryPath,registryDisplayPath:M(e,e.registryPath),frameworks:e.getFrameworks(),dependencies:Ve(m),publicApiKey:p.envValue??void 0,devToolsVersion:e.version};if(a)return g;if(t!=null){let f=l.find(S=>S.cmpInfo.id===t);if(!f)throw new Error(`Component ${t} not found`);let h=c.sourceFile,d=g.components.find(S=>S.id===t),y=await Bs(e,f);we(d,y),t=Array.isArray(t)?t[0]:t;let F=We(t,m,D,n,r,o,s),{elements:w,elmIndex:b,statementIndex:E,statement:B,variableDeclaration:U}=await Qc(e,h,f),I=!1;if(F.addCmpToRegistry?(w.push(Yc(e,F.addCmpToRegistry)),I=!0):F.removeCmpFromRegistry?(w.splice(b,1),I=!0):F.updateRegisteredCmp&&(w[b]=ee(e,w[b],F.updateRegisteredCmp),I=!0),I&&i){let S=[...h.statements];S[E]=e.ts.factory.updateVariableStatement(B,B.modifiers,e.ts.factory.updateVariableDeclarationList(B.declarationList,[e.ts.factory.updateVariableDeclaration(U,U.name,U.exclamationToken,U.type,e.ts.factory.createArrayLiteralExpression(ze(e,w)))])),h=e.ts.factory.updateSourceFile(h,S),d.exportType==="named"?h=L(e,h,{namedImports:[d.importName],importPath:_(e,e.registryPath,d.filePath)}):h=L(e,h,{defaultImport:d.importName,importPath:_(e,e.registryPath,d.filePath)}),h=L(e,h,{namedImports:["RegisteredComponent"],importPath:"@builder.io/sdk-qwik",isTypeOnly:!0}),h=qe(e,h,{variableName:"CUSTOM_COMPONENTS",arrayType:"RegisteredComponent"}),h=Ge(e,h),h=Ke(e,h);let v=te(e,h);v=Re(v),v=Ps(v,Xc,"CUSTOM_COMPONENTS"),v=await e.formatCode(e.registryPath,v),await e.writeFile(e.registryPath,v)}g.components=F.components}return g}function Yc(e,t){return ee(e,e.ts.factory.createObjectLiteralExpression([e.ts.factory.createPropertyAssignment("component",e.ts.factory.createIdentifier(t.importName))],!0),t)}async function Qc(e,t,n){let r=X(e,t,"CUSTOM_COMPONENTS");if(!r)throw new Error(`Exported name of the Builder registry must be "CUSTOM_COMPONENTS". Please update your Builder registry file: ${e.registryPath}`);let o=r.arrayLiteralExp.elements.filter(i=>e.ts.isObjectLiteralExpression(i)),s=-1;for(let i=0;i<o.length;i++)if((await Gn(e,t,o[i]))?.id===n.cmpInfo.id){s=i;break}return{...r,elements:o,elmIndex:s}}var Xc=["This array is used to integrate custom components within Builder.","https://www.builder.io/c/docs/custom-components-intro","",'These components will be found the "Custom Components"',"section of Builder's visual editor.",'You can also turn on "components only mode" to limit',"editing to only these components.","https://www.builder.io/c/docs/guides/components-only-mode"];async function Ls(e){let t=await Zc(e);return{builderPageOptions:async()=>({templateContentId:"dc70f1d979ad416d8fd357137eb9ddfb",pathname:"/",title:"Builder + Qwik Demo Page"}),ensureBuilderSetup:()=>ks(t),ensureFigmaImportPage:async()=>[],getRegistryPath:()=>t.registryPath,getRegistry:r=>At(t,null,!1,!1,null,null,!1,!!r?.readAllInputTypes),addExternalPackage:async r=>{},loadComponent:async r=>{let o=await At(t,r.cmpId,!1,!1,null,null,!1,!1);return{...o,component:o.components.find(s=>s.id===r.cmpId)}},registerComponent:r=>At(t,r.cmpId,!0,!1,null,null,!0,!1),setRegisteredComponentInfo:r=>At(t,r.cmpId,!1,!1,r,null,!0,!1),setRegisteredComponentInput:r=>At(t,r.cmpId,!1,!1,null,r,!0,!1),unregisterComponent:r=>At(t,r.cmpId,!1,!0,null,null,!0,!1),getPublicApiKey:()=>pr(t),setPublicApiKey:r=>vs(t,r.publicApiKey),getDependencies:r=>[{name:"@builder.io/dev-tools"},{name:"@builder.io/sdk-qwik"}],getDevRunCommand:()=>"dev",getCache:()=>_e(t),setCache:r=>Me(t,r)}}async function Zc(e){let t=await er(e,e.getAppRootDir(),"components");if(!t)throw new Error(`Could not find components directory within project: ${e.getAppRootDir()}`);let n=await Se(e,t),r=e.join(e.getAppRootDir(),".env");return{...e,componentsDir:t,registryPath:n,envPath:r}}async function mr(e){return await pt(e,[".env"],dr)}async function Os(e,t){let n=await mr(e),r=await mt(e,n.file,n.envKey,t);return{...n,modifiedType:r}}var dr="PUBLIC_BUILDER_KEY";var ep=new Set(["dist","node_modules"]);async function _s(e,t){let n=[],r=t.getSourceFiles(),o=t.getTypeChecker(),s=e.join(e.getAppRootDir(),"build");return await Promise.all(r.map(async i=>{let a=e.basename(i.fileName);if(a.startsWith(".")||a==="node_modules"||Rr(e,ep,i.fileName)||tp.has(a)||a.includes("$."))return;let u=e.normalize(i.fileName);if(u===e.remixConfigPath||u===s)return;let l=await dt(e,o,u,i,u===e.registryPath);n.push(...l)})),n}var tp=new Set(["root.tsx","root.ts","root.jsx","root.js","_index.tsx","_index.jsx","_index.ts","_index.js"]);async function Ms(e){await zr(e);let t=await e.readFile(e.registryPath);return t?rp(e,t):{components:[],sourceFile:N(e,"")}}async function rp(e,t){let n=N(e,t);return np(e,n)}async function np(e,t){let n=[],r=X(e,t,"CUSTOM_COMPONENTS");return r&&await Promise.all(r.arrayLiteralExp.elements.map(async(o,s)=>{let i=await Wn(e,t,o);i&&(i.nodeIndex=s,n.push(i))})),{sourceFile:t,components:fe(n)}}async function Wn(e,t,n){if(!e.ts.isObjectLiteralExpression(n))return null;let r={id:"",name:"",displayFilePath:"",exportName:"",importName:"",filePath:"",relFilePath:"",importPath:"",inputs:[],acceptsChildren:!1,framework:"react"};e.sdkVersion===A.gen2&&jt(e,n)&&(r.acceptsChildren=!0);for(let o of n.properties){if(!e.ts.isPropertyAssignment(o)||!e.ts.isIdentifier(o.name))continue;if(K(e,o)==="component"){let i,{initializer:a}=o;if(e.ts.isIdentifier(a))i=a.text;else if(e.ts.isCallExpression(a)){(e.ts.isIdentifier(a.expression)&&a.expression.text)==="withChildren"&&(r.acceptsChildren=!0);let c=a.arguments[0];e.ts.isIdentifier(c)&&(i=c.text)}if(!i)continue;r.name===""&&(r.name=G(i)),r.importName=i;let u=await Ue(e,e.registryPath,t,i);if(!u)continue;if(r.filePath=u.filePath,r.relFilePath=u.relFilePath,await e.exists(u.filePath)?r.importPath=W(e,u.filePath):(r.externalImportPath=u.importPath,r.importPath=r.externalImportPath),r.displayFilePath=u.displayFilePath,r.exportType=u.exportType,r.externalImportPath)r.exportName=i;else{let l=await os(e,u.filePath,e.registryPath===u.filePath||he(u.filePath));if(l&&l.length>0)if(l.length===1)r.exportName=l[0].cmpInfo.exportName;else{let c=l.find(p=>p.cmpInfo.exportName===i);c&&(r.exportName=c.cmpInfo.exportName)}}continue}}return r=ge(e,r,n),r.filePath&&r.exportName&&(r.id=await z(e,r.filePath,r.exportName,r.externalImportPath)),r}async function He(e,t,n,r,o,s,i,a){let u=await ft(e),[l,c,p]=await Promise.all([_s(e,u),Ms(e),mr(e)]),m=l.map(y=>y.cmpInfo),D=c.components,g={components:Be(m,D),registryPath:e.registryPath,registryDisplayPath:M(e,e.registryPath),frameworks:e.getFrameworks(),dependencies:Ve(m),publicApiKey:p.envValue??void 0,devToolsVersion:e.version};if(a)return g.components=await Kt(e,g.components),g;let f=!1,h=c.sourceFile,d=Array.isArray(t)?t:typeof t=="string"?[t]:[];if(d.length>0){let y=d.map(b=>{let E=l.find(B=>B.cmpInfo.id===b);if(!E)throw new Error(`Component ${b} not found`);return E}),F=Array.from(new Set(y.map(b=>b.cmpInfo.filePath))),w=await Z(e,F);for(let b of y){let E=g.components.find(V=>V.id===b.cmpInfo.id),B=await zt(e,b,w,e.registryPath===b.cmpInfo.filePath||he(b.cmpInfo.filePath));we(E,B);let U=m.findIndex(V=>V.id===b.cmpInfo.id);m[U].inputs=B;let I=We(b.cmpInfo.id,m,D,n,r,o,s),{elements:S,elmIndex:v,statementIndex:ce,statement:Te,variableDeclaration:ie}=await op(e,h,b);if(I.addCmpToRegistry)S.push(ip(e,I.addCmpToRegistry)),f=!0;else if(I.removeCmpFromRegistry)S.splice(v,1),f=!0;else if(I.updateRegisteredCmp){let V=ee(e,S[v],I.updateRegisteredCmp);S[v]=e.ts.factory.updateObjectLiteralExpression(V,[js(e,I.updateRegisteredCmp),...V.properties.slice(1)]),f=!0}if(f&&i){let V=[...h.statements];V[ce]=e.ts.factory.updateVariableStatement(Te,Te.modifiers,e.ts.factory.updateVariableDeclarationList(Te.declarationList,[e.ts.factory.updateVariableDeclaration(ie,ie.name,ie.exclamationToken,ie.type,e.ts.factory.createArrayLiteralExpression(ze(e,S)))])),h=e.ts.factory.updateSourceFile(h,V),E.exportType==="named"?h=L(e,h,{namedImports:[E.importName],importPath:E.externalImportPath?E.externalImportPath:_(e,e.registryPath,E.filePath)}):h=L(e,h,{defaultImport:E.importName,importPath:E.externalImportPath?E.externalImportPath:_(e,e.registryPath,E.filePath)});let pe=e.sdkVersion===A.gen2?"@builder.io/sdk-react":"@builder.io/react";h=L(e,h,{namedImports:["RegisteredComponent"],importPath:pe,isTypeOnly:!0}),E.acceptsChildren&&e.sdkVersion!==A.gen2&&(h=L(e,h,{namedImports:["withChildren"],importPath:"@builder.io/react"})),h=qe(e,h,{variableName:"CUSTOM_COMPONENTS",arrayType:"RegisteredComponent"}),g.components=I.components,D=I.components.filter(Et=>Et.isRegistered)}}}if(f&&i){h=Ge(e,h),h=Ke(e,h);let y=te(e,h);y=Re(y),y=await e.formatCode(e.registryPath,y),await e.writeFile(e.registryPath,y)}return g}function js(e,t){if(e.sdkVersion===A.gen2)return e.ts.factory.createPropertyAssignment("component",e.ts.factory.createIdentifier(t.importName));let n=e.ts.factory.createIdentifier(t.importName),r=t.acceptsChildren?e.ts.factory.createCallExpression(e.ts.factory.createIdentifier("withChildren"),void 0,[n]):n;return e.ts.factory.createPropertyAssignment("component",r)}function ip(e,t){return ee(e,e.ts.factory.createObjectLiteralExpression([js(e,t),...t.acceptsChildren&&e.sdkVersion===A.gen2?[e.ts.factory.createPropertyAssignment("canHaveChildren",e.ts.factory.createTrue())]:[]],!0),t)}async function op(e,t,n){let r=X(e,t,"CUSTOM_COMPONENTS");if(!r)throw new Error(`Exported name of the Builder registry must be "CUSTOM_COMPONENTS". Please update your Builder registry file: ${e.registryPath}`);let o=r.arrayLiteralExp.elements.filter(i=>e.ts.isObjectLiteralExpression(i)),s=-1;for(let i=0;i<o.length;i++)if((await Wn(e,t,o[i]))?.id===n.cmpInfo.id){s=i;break}return{...r,elements:o,elmIndex:s}}async function Us(e){let t=[],n=await up(e,t);return t.push(...await zr(e)),await cp(e,n),await ap(e,t),t}async function Vs(e){let t=[];return t.push(...await zr(e)),await sp(e,t),t}async function sp(e,t){let n=`figma-imports.${e.typescriptEnabled?"tsx":"jsx"}`;e.hasLocaleParam&&(e.debug("remixEnsureFigmaImportRoute, hasLocaleParam"),n=`($locale).${n}`);let r=e.join(e.routesDir,n),o=await e.exists(r);e.debug(`remixEnsureFigmaImportRoute, hasRoute: ${o}`);let s=await e.formatCode(r,Ks({sys:e,routePath:r,modelName:"figma-imports"}));await e.writeFile(r,s),t.push({filePath:r,modifiedType:o?"update":"create"})}async function ap(e,t){let n=`$.${e.typescriptEnabled?"tsx":"jsx"}`;e.hasLocaleParam&&(e.debug("remixEnsureAppRoute, hasLocaleParam"),n=`($locale).${n}`),e.sdkVersion===A.gen2&&(n=`($slug)._index.${e.typescriptEnabled?"tsx":"jsx"}`);let r=e.join(e.routesDir,n),o=await e.exists(r);e.debug(`remixEnsureAppRoute, hasRoute: ${o}`);let s=await e.formatCode(r,Ks({sys:e,routePath:r,modelName:"page"}));await e.writeFile(r,s),t.push({filePath:r,modifiedType:o?"update":"create"})}function Ks({sys:e,routePath:t,modelName:n}){let r=e.typescriptEnabled,o=_(e,t,e.registryPath),s="",i="";r&&(s="import type { LoaderArgs } from '@remix-run/server-runtime';",i=": LoaderArgs");let a=`process.env.${dr}`,u="";return e.getFrameworks().some(l=>l.name==="@shopify/remix-oxygen")&&(a=`context.env.${dr}`,u=", context"),r&&(a+="!"),e.sdkVersion===A.gen2?`
...
`:""}
`}async function up(e,t){let r=e.typescriptEnabled?"tsx":"jsx",o=e.join(e.componentsDir,"Counter"),s=e.join(o,`Counter.${r}`),i=e.join(o,"styles.module.css"),{component:a,styles:u}=lp(e),l=await e.exists(s);if(e.debug(`remixEnsureCounterComponent, hasCounterCmp: ${l}`),!l){let p=await e.formatCode(s,a);await e.writeFile(s,p),t.push({filePath:s,modifiedType:"create"})}let c=await e.exists(i);return e.debug(`remixEnsureCounterComponent, hasCounterStyles: ${c}`),c||(await e.writeFile(i,u),t.push({filePath:i,modifiedType:"create"})),s}function lp(e){let t=e.typescriptEnabled,n=`
...
`.trimStart()}async function Xs(e,t,n){if(!await e.exists(e.registryPath)){if(e.sdkVersion===A.gen2){let s=bp(e);await e.writeFile(e.registryPath,s)}else await e.writeFile(e.registryPath,"");t.push({filePath:e.registryPath,modifiedType:"create"})}if(!n)return;let o=(await Ye(e,null,!1,!1,null,null,!1,!1)).components.find(s=>s.filePath===n);o&&await Ye(e,o.id,!0,!1,null,null,!0,!1)}async function Fp(e,t){let r=e.typescriptEnabled?"tsx":"jsx",o=e.join(e.componentsDir,"Counter"),s=e.join(o,`Counter.${r}`),i=e.join(o,"styles.module.css"),{component:a,styles:u}=wp(e);if(!await e.exists(s)){let l=await e.formatCode(s,a);await e.writeFile(s,l),t.push({filePath:s,modifiedType:"create"})}return await e.exists(i)||(await e.writeFile(i,u),t.push({filePath:i,modifiedType:"create"})),s}function wp(e){let t=e.typescriptEnabled,n=`
"use client"
import React, { useState } from "react";
import styles from "./styles.module.css";
${t?`
...
`}
  ...
  `.trimStart()}function tm(e){return e.typescriptEnabled?`import type { RegisteredComponent } from "@builder.io/sdk-angular";
    
export const CUSTOM_COMPONENTS: RegisteredComponent[] = [
];`:`export const CUSTOM_COMPONENTS = [
  ];
  `}async function rm(e,t){let r=e.typescriptEnabled?"ts":"js",o=e.join(e.componentsDir,`counter.component.${r}`),s=await e.exists(o);e.debug(`angularEnsureCounterComponent, hasCounterCmp: ${s}`);let i=nm(e);if(!s){let a=await e.formatCode(o,i);await e.writeFile(o,a),t.push({filePath:o,modifiedType:"create"})}return o}function nm(e){return`
import { Component, Input } from '@angular/core';
...
${(0,C.yellow)("Arguments:")}
  ...
  ${(0,C.cyan)("--clearMappings")}  Remove all mappings from the space, publishing zero mappings`);break;case"migrate":j.info(`${(0,C.cyan)("\u2192")} ${(0,C.bold)("Migrate Mappings")}
...
${(0,C.yellow)("Arguments:")}
  ...
  ${(0,C.cyan)("--installCommand")}  Command to install dependencies (defaults to npm install)`);break;default:j.info(`${(0,C.bold)("Available Commands:")}
`),[{command:"generate URL [URL ...]",description:"Start the auto-mapping wizard for Figma Component URLs"},{command:"publish",description:"Publish your Figma Mappings to Builder.io"},{command:"migrate",description:"Migrate existing Figma Mappings into the repo as local files"},{command:"auth",description:"Re-authenticate with Figma and Builder.io"},{command:"code",description:"Generate or modify code based on Figma designs"},{command:"indexing",description:"Index your codebase to improve code generation results"},{command:"index-repo",description:"Index your entire repository to improve code generation results"},{command:"code-server",description:"Start a development server that provides project file information and code analysis"},{command:"launch",description:"Launch a development server"}].forEach(({command:n,description:r})=>{j.info(`${(0,C.cyan)("\u2192")} ${(0,C.bgGreen)((0,C.white)(` npx ${xe()} figma ${n} `))}
   ${(0,C.dim)(r)}
`)}),j.info(`
Use ${(0,C.cyan)(`npx ${xe()} figma help <command>`)} for detailed help about a command`)}sr("bye \u{1F44B}")}async function Oi(e){let{default:t}=await import("open");await t(e)}var Fw=`
   `+(0,Xe.dim)("ESC to interrupt");var Pe=T(require("typescript"),1);function _i(e){return!(e.category!==Pe.DiagnosticCategory.Error||!e.file||e.code===6133||e.code===6138||e.code===6305||e.code===6196||e.code===6192||e.code===6198||e.code===6199||e.code===6205||e.code===1449||e.code===2578||e.code===7006||e.code===5074||e.code===7026||e.code===2503||e.code===2695||e.code===2322)}async function cd(e,t,n){let r=[],o=[t],s=e.relative(e.getAppRootDir(),t.fileName);for(;o.length>0;){let i=o.shift();if(gd(i,t)){let a=md(e,i,t,n),{line:u,character:l}=t.getLineAndCharacterOfPosition(i.getStart());a&&(a.loc=`${s}:${u+1}:${l+1}`,r.push(a))}o.push(...i.getChildren(t))}return r}var pd="figmaMapping";function md(e,t,n,r){let[o]=t.arguments;if(!o)throw new Error("Invalid figmaMapping call, no arguments found");if(!O.default.isObjectLiteralExpression(o))throw new Error("Invalid figmaMapping call, argument is not an object literal");let s=o.properties;if(!s)throw new Error("Invalid figmaMapping call, argument has no properties");let i="",a,u,l,c="-",p=e.basename(n.fileName).replace(/\.mapper\.[tsxjm]+$/,""),m,D,g,f;if(t.typeArguments&&t.typeArguments.length>0){let y=fu(t.typeArguments[0].getText(n));y&&(p=y)}for(let y of s){let F=y.name?.getText(n);if(!F)throw new Error("Invalid figmaMapping call, property has no name");switch(F){case"componentName":{if(!("initializer"in y))throw new Error("Invalid figmaMapping call, componentName has no initializer");let w=y.initializer;if(!O.default.isStringLiteral(w))throw new Error("Invalid figmaMapping call, componentName is not a string literal");a=w.text;break}case"url":{if(!("initializer"in y))throw new Error("Invalid figmaMapping call, url has no initializer");let w=y.initializer;if(!O.default.isStringLiteral(w))throw new Error("Invalid figmaMapping call, url is not a string literal");f=w.text;break}case"componentKey":{if(!("initializer"in y))throw new Error("Invalid figmaMapping call, componentKey has no initializer");let w=y.initializer;if(!O.default.isStringLiteral(w))throw new Error("Invalid figmaMapping call, componentKey is not a string literal");i=w.text;break}case"mapper":if(O.default.isMethodDeclaration(y)){let w=function(E){let U=r.getSymbolAtLocation(E)?.getDeclarations()?.[0];if(U){let I=fd(U);if(I?.importClause){let S=I.importClause.name?.getText(n);return S===c?(m="default",D=S):I.importClause.namedBindings&&O.default.isNamedImports(I.importClause.namedBindings)&&(m="named",I.importClause.namedBindings.elements.forEach(v=>{v.name.getText(n)===c&&(D=v.name.getText(n))})),D&&O.default.isStringLiteral(I.moduleSpecifier)&&(g=I.moduleSpecifier.text),!0}}return!1},b=function(E){if((O.default.isJsxOpeningElement(E)||O.default.isJsxSelfClosingElement(E))&&O.default.isIdentifier(E.tagName)){c=E.tagName.getText(n),w(E.tagName);return}else if(O.default.isTaggedTemplateExpression(E)&&O.default.isIdentifier(E.tag)&&E.tag.escapedText==="html"){if(O.default.isTemplateExpression(E.template)){let U=E.template.templateSpans.find(I=>O.default.isIdentifier(I.expression)&&dd(I.expression.text)&&w(I.expression));if(U&&O.default.isIdentifier(U.expression)){c=U.expression.text;return}}let B=E.template.getText(n).match(/^`\s*<([^\s]+)/);if(B){c=B[1];return}}else O.default.forEachChild(E,b)};var h=w,d=b;if(y.parameters&&y.parameters.length>0&&y.parameters[0]&&y.parameters[0].type){let E=y.parameters[0].type.getText(n),B=fu(E);B&&(p=B)}O.default.forEachChild(y,b),l=y.getText(n).replace(/^mapper/,"function Mapper"),u=Mi(l);break}case"designTokenMapper":if(O.default.isMethodDeclaration(y)){l=y.getText(n).replace(/^designTokenMapper/,"function Mapper"),u=Mi(l),i="design-tokens";break}case"genericMapper":if(O.default.isMethodDeclaration(y)){l=y.getText(n).replace(/^genericMapper/,"function Mapper"),u=Mi(l),i="*";break}}}if(!i&&!f)throw new Error("Invalid figmaMapping call, no componentKey or url found");if(!i&&!u)throw new Error("Invalid figmaMapping call, no mapper found");if(!i&&!l)throw new Error("Invalid figmaMapping call, no original mapper found");return{builderName:c,figmaName:a??p,figmaKey:i,figmaUrl:f,inputMapper:u,exportType:m,importName:D,importPath:g,originalInputMapper:l,imports:Cd(n),source:"cli"}}function dd(e){return e.charAt(0)===e.charAt(0).toUpperCase()}function Mi(e){return O.default.transpile(e,{target:O.default.ScriptTarget.Latest,allowNonTsExtensions:!0,moduleResolution:O.default.ModuleResolutionKind.NodeJs,module:O.default.ModuleKind.CommonJS,noImplicitAny:!1,esModuleInterop:!0,noUnusedLocals:!1,noUnusedParameters:!1,jsx:O.default.JsxEmit.React,jsxFactory:"React.createElement",jsxFragmentFactory:"React.Fragment",allowJs:!0,checkJs:!0,strict:!0,suppressImplicitAnyIndexErrors:!0,typeRoots:["node_modules/@types"],inlineSources:!0,inlineSourceMap:!0})}function fd(e){let t=e;for(;t;){if(O.default.isImportDeclaration(t))return t;t=t.parent}}function gd(e,t){return O.default.isCallExpression(e)&&e.expression.getText(t)===pd}async function gu(e){let t=["node_modules","dist","build","public"];return(await e.readdirRecursive(e.getAppRootDir(),t)).filter(r=>he(r))}function fu(e){let t=e.match(/^Figma(\w+)Props$/);if(t&&typeof t[1]=="string")return t[1]}async function Du(e,t,n,r=!1){try{return n||(n=await on(e)),(await n.setPublicApiKey({publicApiKey:t})).modifiedType==="permission-error"?{success:!1,error:"permission-error"}:(r&&await n.ensureFigmaImportPage(),{success:!0})}catch(o){let s="unknown-error";return o instanceof Error?s=o.message:typeof o=="string"&&(s=o),{success:!1,error:s}}}var Dd={getCanonicalFileName:e=>e,getCurrentDirectory:()=>O.default.sys.getCurrentDirectory(),getNewLine:()=>O.default.sys.newLine};function hd(e){return O.default.formatDiagnosticsWithColorAndContext(e,Dd)}async function hu({sys:e,mappingFiles:t,typeCheck:n}){if(e.Sentry?.setContext("findMappings",{mappingFiles:t}),!t.length)return{mapperFiles:[],figmaBuilderLinks:[],figmaLinksToResolve:[],diagnostics:[]};let r=[],o=[],s=[],i=await Z(e,t),a=i.getTypeChecker(),u=i.getSyntacticDiagnostics().filter(_i).filter(p=>p.file?.fileName?t.includes(p.file.fileName):!1);if(u.length>0)return j.error(`At least one of the mappings contain syntactic errors:

${hd(u)}`),at(1);let l=[...n?i.getSemanticDiagnostics():[]].filter(_i);for(let p of t)try{let m=i.getSourceFile(p);if(!m){e.Sentry?.captureException(new Error("Could not find source file"),{extra:{file:p,sourceFiles:i.getSourceFiles().map(f=>f.fileName)},level:"warning"});continue}let D=m?.fileName;if(o.push({filePath:p,content:m.getText()}),D){let f=l.filter(h=>h.file?.fileName===D);f.length>0&&s.push(...f)}let g=await cd(e,m,a);r.push(...g)}catch(m){return e.Sentry?.captureException(m),await at(1)}let c=r.filter(p=>p.figmaUrl&&!p.figmaKey).map(p=>p.figmaUrl);return{mapperFiles:o,figmaBuilderLinks:r,figmaLinksToResolve:c,diagnostics:s}}function Cd(e){let t=[];for(let n of e.statements){if(!O.default.isImportDeclaration(n)||!n.importClause||n.importClause.isTypeOnly||!O.default.isStringLiteral(n.moduleSpecifier))continue;let r=n.moduleSpecifier.text;if(r.startsWith("@builder.io"))continue;n.importClause.name&&t.push({importType:"default",importName:n.importClause.name.text,importPath:r});let o=n.importClause.namedBindings;if(o&&O.default.isNamedImports(o))for(let s of o.elements)s.isTypeOnly||t.push({importType:"named",importName:s.name.text,importPath:r})}return t}var Eu=require("crypto");var xd=5294,yd=5284,Ui=4,ji=e=>!!(process.env.CI||e.ci),wr=async(e,t,n)=>{let r=ji(t)?{}:bd(e),o=r.spaceName,s,i=t.builderUserId??process.env.BUILDER_USER_ID??r.userId,a=t.builderPublicKey??process.env.BUILDER_PUBLIC_KEY??r.builderPublicKey,u=t.builderPrivateKey??process.env.BUILDER_PRIVATE_KEY??r.builderPrivateKey,l=process.env.FIGMA_PERSONAL_TOKEN??t.figmaToken;if(l?s={access_token:l,oauth:!1}:s=r.figmaAuth,n.forceSpaceId&&!t.yes&&a&&a!==n.forceSpaceId&&(j.warning(`CLI is currently logged in space ${(0,yt.yellow)(a)},
However the command required --spaceId=${(0,yt.green)(n.forceSpaceId)}`),await or({message:"Do you wanna switch spaces?",active:"Yes",inactive:`Stay in current ${o} space`})?(a=n.forceSpaceId,u=void 0,o=void 0,i=void 0):j.warning("Staying in the current space. Some other auth issues might occur.")),ji(t)){if(!s&&n.figmaAuth)throw new Error(`No Figma personal token found.
