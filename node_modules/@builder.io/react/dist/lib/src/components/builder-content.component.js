...
var BuilderContent = /** @class */ (function (_super) {
            ...
            switch (message.type) {
                case 'builder.patchUpdates': {
                    ...
                    for (var _i = 0, patches_1 = patches; _i < patches_1.length; _i++) {
                        ...
                        (0, apply_patch_with_mutation_1.applyPatchWithMinimalMutationChain)(_this.state.data, patch);
                    }
                    _this.setState({
                    ...
                    if (_this.props.contentLoaded) {
                        _this.props.contentLoaded((_c = _this.state.data) === null || _c === void 0 ? void 0 : _c.data, _this.state.data);
                    }
                    break;
                }
            }
    ...
    Object.defineProperty(BuilderContent.prototype, "options", {
        get: function () {
            ...
            if (!options.key && ((_a = this.props.content) === null || _a === void 0 ? void 0 : _a.id)) {
                options.key = this.props.content.id;
            }
            if (this.props.content && !((_b = options.initialContent) === null || _b === void 0 ? void 0 : _b.length)) {
