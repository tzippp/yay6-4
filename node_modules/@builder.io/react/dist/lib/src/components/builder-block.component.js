            ...
            switch (message.type) {
                ...
                case 'builder.patchUpdates': {
                    ...
                    for (var _i = 0, patches_1 = patches; _i < patches_1.length; _i++) {
                        ...
                        (0, apply_patch_with_mutation_1.applyPatchWithMinimalMutationChain)(newBlock, patch);
                    }
            ...
            if (self.responsiveStyles) {
                for (var _i = 0, reversedNames_1 = reversedNames; _i < reversedNames_1.length; _i++) {
                    ...
                    if (size === 'large') {
                        ...
                        styles["@media only screen and (max-width: ".concat(device_sizes_constant_1.sizes[size].max, "px)")] = {
