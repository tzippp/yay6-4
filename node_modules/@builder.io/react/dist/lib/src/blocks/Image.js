...
var getSizes = function (sizes, block) {
...
var ImageComponent = /** @class */ (function (_super) {
    ...
    ImageComponent.prototype.render = function () {
        var _this = this;
        var _a;
        var _b = this.props, aspectRatio = _b.aspectRatio, lazy = _b.lazy;
        var children = this.props.builderBlock && this.props.builderBlock.children;
        var srcset = this.props.srcset;
        var sizes = (0, exports.getSizes)(this.props.sizes, this.props.builderBlock);
        ...
        var isPixel = (_a = this.props.builderBlock) === null || _a === void 0 ? void 0 : _a.id.startsWith('builder-pixel-');
